...
// Read default locale for ojL10n loader from oraclejetconfig.json; fallback to 'en-US'
const defaultOjL10nLocale = (
  ojetUtils.getOraclejetConfigJson() || {}
).defaultWebpackOjL10nLocale || 'en-US';
...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.LoaderOptionsPlugin({
      options: {
        ojL10nLoader: {
          locale: webpackUtils.supportMultiLocale() ? 'multi' : defaultOjL10nLocale,
        },
      },
    }),
