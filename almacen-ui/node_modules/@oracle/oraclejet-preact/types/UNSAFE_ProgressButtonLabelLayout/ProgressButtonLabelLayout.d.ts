 ...
 * @returns
 */
export declare function ProgressButtonLabelLayout({ size, display, styling, isLoadingContrast, isLoading, children, startIcon }: Props): import("preact").JSX.Element;
export declare namespace ProgressButtonLabelLayout {
