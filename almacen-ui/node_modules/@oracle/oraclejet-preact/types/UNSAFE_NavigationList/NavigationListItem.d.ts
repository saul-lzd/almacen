...
export declare function NavigationListItem<K extends string | number>({ itemKey, label, badge, metadata, severity, icon }: NavigationListItemProps<K>): import("preact").JSX.Element;
