...
type BaseProps = Pick<UnpackSignals<JSX.AriaAttributes>, 'aria-label' | 'aria-valuemax' | 'aria-valuemin' | 'aria-valuenow' | 'aria-valuetext'>;
type AriaProps = Required<Pick<BaseProps, 'aria-valuemin' | 'aria-valuemax'>> & // these two required
Omit<BaseProps, 'aria-valuemin' | 'aria-valuemax'>;
type Props = AriaProps & {
    ...
    isSelected?: boolean;
    /**
     * The order of the segments, like ['month', 'day', 'year']. This is necessary to pass into the dispatch actions
     */
 ...
 */
export declare const DateSegment: ({ "aria-label": ariaLabel, "aria-valuemax": ariaValueMax, "aria-valuemin": ariaValueMin, "aria-valuenow": ariaValueNow, "aria-valuetext": ariaValueText, inputRef, isComplete, isDisabled, isFieldFocused, isHidden, isHighlighted, isInvalid, isRequired, isSelected, onChange, orderedSegments, placeholder, text, type }: Props) => JSX.Element;
export {};
