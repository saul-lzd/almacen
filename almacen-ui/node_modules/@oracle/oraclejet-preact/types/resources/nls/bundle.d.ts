declare const bundle: {
    ...
    accButtonProgressComplete: (p: {
        label: string;
    }) => string;
    accButtonProgressStatus: (p: {
        label: string;
    }) => string;
    accColorPalette: () => string;
    accColorSwatch: () => string;
    accCommandKey: () => string;
    accContextMenuLabel: () => string;
    ...
    chart_labelDataLabel: () => string;
    chart_labelGroup: () => string;
    chart_labelSeries: () => string;
    chart_labelValue: () => string;
    chart_labelWidthWeight: () => string;
    chart_labelX: () => string;
    chart_labelY: () => string;
    checkboxSet_requiredMessageDetail: () => string;
    checkbox_helpForCheckbox: () => string;
    checkbox_requiredMessageDetail: () => string;
    checkbox_selected: () => string;
    checkbox_unselected: () => string;
    close: () => string;
    collection_apply: () => string;
    collection_cancel: () => string;
    collection_loaded: () => string;
    collection_loading: () => string;
    collection_noData: () => string;
    collection_pixels: () => string;
    collection_resizeColumnDialog: () => string;
    collection_resizeColumnMenu: () => string;
    collection_resizeMessageDetail: (p: {
        MIN: string;
        MAX: string;
    }) => string;
    ...
    collection_sortAscendingSubMenu: () => string;
    collection_sortColumnMenu: () => string;
    collection_sortDescendingSubMenu: () => string;
    collection_sortDisabled: () => string;
    collection_sortEnabled: () => string;
    collection_width: () => string;
    ...
    diagram_promotedLink: () => string;
    diagram_promotedLinkAriaDesc: () => string;
    diagram_promotedLinks: (p: {
        num_links: string;
    }) => string;
    error: () => string;
    ...
    formControl_empty_segment: () => string;
    formControl_helpAvailable: () => string;
    formControl_hide: () => string;
    formControl_hour: () => string;
    ...
    formControl_millisecond: () => string;
    formControl_minute: () => string;
    formControl_month: () => string;
    formControl_readOnly: () => string;
    formControl_requiredMessageDetail: () => string;
    formControl_second: () => string;
    formControl_selectionExactMessageDetail: (p: {
        n: string;
    }) => string;
    formControl_selectionOverflowMessageDetail: (p: {
        max: string;
    }) => string;
    formControl_selectionRangeMessageDetail: (p: {
        min: string;
        max: string;
    }) => string;
    formControl_selectionUnderflowMessageDetail: (p: {
        min: string;
    }) => string;
    ...
    inputTimeMask_timeRangeOverflowMessageDetail: (p: {
        max: string;
    }) => string;
    inputTimeMask_timeRangeUnderflowMessageDetail: (p: {
        min: string;
    }) => string;
    inputTimeMask_time_cleared: () => string;
    labelNone: () => string;
    list_msgFetchCompleted: () => string;
    list_msgFetchingData: () => string;
    list_suggestion: () => string;
    menu_stateLoading: () => string;
    ...
    message_navigationToTouch: () => string;
    message_warning: () => string;
    noData_message: () => string;
    overflowItemLabel: () => string;
    plural_separator: () => string;
    popup_close_skipLink: () => string;
    popup_liveRegion_F6_initial_focus_firstFocusable: () => string;
    popup_liveRegion_F6_initial_focus_none: () => string;
    progressIndeterminate: () => string;
    radioButton_checked: () => string;
    radioButton_selected: () => string;
    radioButton_unchecked: () => string;
    ...
    tabBar_tabContainsErrors: () => string;
    tabbar_accAnnounceRemovedKey: (p: {
        itemKey: string;
    }) => string;
    tabbar_labelContextMenu: () => string;
    tabbar_labelMoveLeft: () => string;
    tabbar_labelMoveRight: () => string;
    tabbar_labelRemove: () => string;
    timeComponent_tooltipZoomIn: () => string;
    timeComponent_tooltipZoomOut: () => string;
    timeConverter_parseError: () => string;
    ...
    vis_stateCollapsed: () => string;
    vis_stateExpanded: () => string;
