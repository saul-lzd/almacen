...
import { DatatipConfig } from "../utils/UNSAFE_visTypes/common";
export type DiagramContextMenuConfig<D1, D2> = ContextMenuConfig<DiagramContextMenuContext<D1, D2>>;
export type DiagramContextMenuContext<D1, D2> = {
    type: 'node';
    data: D1;
} | {
    type: 'link';
 ...
 * Props for Diagram
 */
export type DiagramProps<K1, K2, D1, D2, L> = {
    /**
     ...
     */
    layout: (context: DiagramLayoutContext<D1, D2>) => L;
    /**
    ...
    /**
     * A callback that returns the custom link content. This callback will take in a context that includes link data,
     * current and previous state of the link, and the output of the layout function and will return the custom link content.
     * The layout output is provided to allow applications to pass information from the layout function to the linkRenderer
     * like the link paths
     */
     ...
     */
    datatip?: DatatipConfig<DatatipContext<D1, D2>>;
    /**
     * Configuration used to specify the context menu.
     */
...
export type DiagramNodeData<K1> = {
    ...
    /**
     * If set to 'inherit' and the selection-mode of the diagram is not set to 'none', the node will be selectable.
     * If set to 'off', the node will not be selectable and onSelection will not be called.
     */
    selectable?: 'inherit' | 'off';
};
/**
...
export type DiagramLinkData<K2, K1> = {
    ...
    labelStyle?: DiagramLabelStyles;
    /**
     * If set to 'inherit' and the selection-mode of the diagram is not set to 'none', the link will be selectable.
     * If set to 'off', the link will not be selectable and onSelection will not be called.
     */
    selectable?: 'inherit' | 'off';
};
/**
...
export type LinkRendererContext<D2, L> = {
    /**
     * Link Data
     */
    data: D2;
 ...
 */
export type DiagramLayoutOutput<K1 extends string | number, K2 extends string | number> = {
    nodes: {
        [key in K1]: DiagramLayoutNodePosition;
    };
    links?: {
        [key in K2]: DiagramLayoutLinkPosition;
    };
};
/**
