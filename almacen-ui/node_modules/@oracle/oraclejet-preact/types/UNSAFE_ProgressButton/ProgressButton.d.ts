 ...
 * @ignore
 */
import { ComponentChildren, ComponentProps, Ref, JSX } from 'preact';
...
import { ButtonIntrinsicProps } from '../utils/UNSAFE_buttonUtils';
...
type Props = IntrinsicProps & ButtonIntrinsicProps & Pick<BaseButtonProps, 'aria-describedby'> & WidthInterpolationProps & TestIdProps & {
    /**
     ...
     */
    onAction?: ComponentProps<typeof BaseButton>['onAction'];
    /**
 ...
 */
export declare const ProgressButton: import("preact").FunctionalComponent<import("preact/compat").PropsWithoutRef<Props> & {
    ref?: Ref<{
        focus: () => void;
        blur: () => void;
        click: () => void;
    } & import("../utils/UNSAFE_unsafeDomAccess").UnsafeDomHandle> | undefined;
}>;
export {};
