...
declare const datePickerViewActionTypes: readonly ["monthView", "monthsGridView", "yearsGridView", "viewBlur"];
declare const monthViewActionTypes: readonly ["dayFocused", "daySelected", "goToToday", "previousDay", "nextDay", "previousWeek", "nextWeek", "previousMonth", "previousMonthAndFocus", "nextMonth", "nextMonthAndFocus", "previousYear", "nextYear", "firstDayOfMonth", "lastDayOfMonth"];
declare const monthsGridViewActionTypes: readonly ["previousMonthInGridView", "nextMonthInGridView", "previousMonthRowInGridView", "nextMonthRowInGridView", "monthFocused", "monthSelected"];
declare const yearsGridViewActionTypes: readonly ["previousYearInGridView", "nextYearInGridView", "previousYearRowInGridView", "nextYearRowInGridView", "previousDecade", "previousDecadeAndFocus", "nextDecade", "nextDecadeAndFocus", "yearFocused", "yearSelected"];
...
declare const useDatePickerState: ({ initialFocusableDate }: Props) => {
    ...
    actions: {
        ...
        dayFocused: (payload: Required<import("#utils/UNSAFE_calendarDateUtils").CalendarDate>) => void;
        ...
        monthFocused: (payload: Pick<Required<import("#utils/UNSAFE_calendarDateUtils").CalendarDate>, "month">) => void;
        ...
        yearFocused: (payload: Pick<Required<import("#utils/UNSAFE_calendarDateUtils").CalendarDate>, "year">) => void;
