...
declare const styles: {
    base: string;
    styled: string;
    styledOutline: string;
    styledOutlineButtonset: string;
    outline: string;
    outlineButtonset: string;
    min: string;
    fill: string;
    spanOnly: string;
    embedded: string;
...
declare const variants: {
    ...
    readonly noHoverActive: {
        readonly isNoHoverActive: string;
        readonly notNoHoverActive: "";
    };
    readonly newStackingContext: {
        readonly isNewStackingContext: string;
        readonly notNewStackingContext: "";
    };
    readonly noUserSelect: {
        readonly isUserSelect: "";
        readonly notUserSelect: string;
    };
};
