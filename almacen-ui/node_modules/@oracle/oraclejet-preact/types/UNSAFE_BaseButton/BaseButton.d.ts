...
export type StylingOptions = 'default' | 'min' | 'embedded' | 'container' | 'unstyled' | 'fill' | 'noBorderRadiusEnd' | 'noBorderRadiusStart' | 'noBorderEnd' | 'noBorderStart' | 'active' | 'selected' | 'buttonSetItem' | 'trailingItem' | 'widthEqual' | 'hiddenLabel' | 'noHoverActive' | 'widthAuto' | 'newStackingContext' | 'noUserSelect';
export type Props = ButtonIntrinsicProps & ButtonIntrinsicAriaProps & DimensionProps & TestIdProps & {
    /**
     ...
     */
    onAction?: ComponentProps<typeof BareButton>['onAction'];
    /**
