 ...
 * @returns The aria props.
 */
export declare function getItemAriaProps(supportsSelection: boolean, translations?: BundleType, isSelected?: boolean, accessibleLabel?: string, role?: UnpackSignals<JSX.HTMLAttributes['role']>): {
    'aria-label': UnpackSignals<JSX.AriaAttributes>['aria-label'];
    role: UnpackSignals<JSX.HTMLAttributes['role']>;
};
/**
...
export declare function getItemProps<K>(item: TagCloudItemData<K>, itemIdx: number, supportsSelection: boolean, isReadOnly: boolean, hoveredItem?: ItemInfo, selectedIds?: Array<K>, focusedItem?: ItemInfo, highlightedIds?: Array<K>, activeId?: string): {
    ...
    accessibleLabel?: string;
    value: number;
    color?: import("../utils/UNSAFE_interpolations/colors").ColorProps["color"];
    role?: UnpackSignals<JSX.HTMLAttributes["role"]>;
    isCurrent: boolean;
