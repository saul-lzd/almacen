...
import type { ContextMenuConfig } from "../UNSAFE_Collection/Collection.types";
import type { ViewportConfig } from "../hooks/UNSAFE_useViewportIntersect";
...
export type TableViewportConfig = ViewportConfig & {
...
export type TableContextMenuConfig<K, D, C> = ContextMenuConfig<CellContextMenuContext<K, D, C>>;
/**
...
export type TableProps<K, D, C extends string> = {
     ...
     * Either aria-label or aria-labelledby is required in order to make TableView accessible.
     */
    'aria-label'?: string;
    /**
    ...
    /**
     * An aria-describedby which identifies the element(s) that describes this TableView.
     */
