 ...
 */
declare const useInputDatePicker: ({ isDisabled, isReadonly, onCommit, onInput, rootRef, value: currentValue }: Props) => {
    calendarIconActionHandler: (details: {
        reason: "pointer" | "keyboard";
    }) => void;
    datePickerCommitHandler: (detail: ValueUpdateDetail<CalendarDateRequired>) => void;
