...
declare const iconUserAssistancePopup: string;
/*******************
 * Component Variants
 *******************/
...
export { styles, assistiveStyles, dividerStyle, helpIconBase, helpIconLabelEdgeStart, helpContentStyles, requiredIconBase, requiredIconLabelEdgeStart, iconUserAssistanceIcon, iconUserAssistancePopup, variants };
