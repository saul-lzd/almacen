type Props = {
    ...
    id?: string;
    /**
     * Variant of the component, either 'checkbox' or 'radio'. Used to determine the help text.
     */
 ...
 */
declare const IconUserAssistance: ({ assistiveText, helpSourceLink, helpSourceText, isTabbable, id, variant }: Props) => import("preact").JSX.Element | null;
