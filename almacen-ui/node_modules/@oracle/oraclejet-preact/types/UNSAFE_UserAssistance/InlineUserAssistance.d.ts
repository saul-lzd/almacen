...
type Props = {
    ...
    showInlineAssistanceOn?: 'focus' | 'always';
    userAssistanceDensity?: UserAssistanceDensityType;
} & TestIdProps;
export declare function InlineUserAssistance({ assistiveText, fieldLabel, helpSourceLink, helpSourceText, id, isRequiredShown, requiredAlignment, messages, showInlineAssistanceOn, userAssistanceDensity, testId }: Props): import("preact").JSX.Element | null;
export {};
