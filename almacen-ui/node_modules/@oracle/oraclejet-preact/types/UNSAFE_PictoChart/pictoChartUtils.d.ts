 ...
 */
export declare function getItemProps<K, D extends PictoChartItemData<K>>(item: D, itemIdx: number, countIdx: number, isReadOnly: boolean, hoveredItem?: ItemInfo, selectedIds?: Array<K>, focusedItem?: ItemInfo, highlightedIds?: Array<K>, activeId?: string, isVert?: boolean, layoutOrigin?: string): {
    isCurrent: boolean;
...
export declare function getPictoDefaultRenderers<K, D extends PictoChartItemData<K> = PictoChartItemData<K>>(rendererOptions: (data: D) => PictoRendererOptions): {
    markerRenderer: (context: MarkerRendererContext<D>) => JSX.Element;
