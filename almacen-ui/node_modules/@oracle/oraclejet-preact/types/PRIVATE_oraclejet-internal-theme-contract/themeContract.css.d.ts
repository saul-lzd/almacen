/**
 * These utilities should stay in sync with those found in ../PRIVATE_oraclejet-theme-cli
 */
declare const PREFIX = "oj-c";
...
declare const colorSchemeVars: {
    ...
    overlay: {
        ...
        dropActive: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    };
    pageBackground: {
    ...
    border: {
        ...
        dividerOpaqueColor: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
        dividerOpaquePercent: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
        selected: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
