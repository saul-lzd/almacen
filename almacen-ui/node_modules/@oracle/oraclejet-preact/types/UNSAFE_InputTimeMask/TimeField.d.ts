 ...
 */
declare const TimeField: ({ "aria-describedby": describedBy, "aria-invalid": ariaInvalid, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, baseId, dispatch, fieldRef, granularity, hasLeadingZeroForHour, hasInsideLabel, isRequired, masks: timeMasks, onBlur, onCommit, onFocus, onInput, state, testId, textAlign, value, variant }: Props) => JSX.Element;
