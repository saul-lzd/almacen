...
type AriaProps = Pick<UnpackSignals<JSX.AriaAttributes>, 'aria-label' | 'aria-valuemax' | 'aria-valuemin' | 'aria-valuenow' | 'aria-valuetext'>;
type DayPeriodProps = {
    type: 'dayPeriod';
    /**
...
type Props = AriaProps & (DayPeriodProps | NonDayPeriodProps) & {
 ...
 */
export declare const TimeSegment: ({ amPm, "aria-label": ariaLabel, "aria-valuemax": ariaValueMax, "aria-valuemin": ariaValueMin, "aria-valuenow": ariaValueNow, "aria-valuetext": ariaValueText, inputRef, isDisabled, isFieldFocused, isHidden, isHighlighted, isInvalid, isRequired, isSelected, onChange, placeholder, text, type }: Props) => JSX.Element;
export {};
