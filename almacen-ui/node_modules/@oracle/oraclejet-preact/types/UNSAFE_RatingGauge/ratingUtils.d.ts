...
export declare function getValue(pageX: number, max: number, step: number, dimensionsRef: RefObject<{
    width: number;
    x: number;
 ...
 * @returns The color in rating gauge, if the color enum is supported. undefined otherwise.
 */
export declare function getColorEnum(color: string | undefined): "gold" | "warning" | "danger" | "success" | "neutral" | undefined;
