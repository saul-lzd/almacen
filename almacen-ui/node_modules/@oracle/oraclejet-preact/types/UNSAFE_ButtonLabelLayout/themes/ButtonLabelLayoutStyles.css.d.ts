import { buttonLabelLayoutVars, scaleVars } from './ButtonLabelLayoutContract.css';
...
declare const progressStyle: string;
/*******************
 * Style Variants
 *******************/
declare const variants: {
    readonly size: {
        readonly xs: {
            readonly vars: {
                readonly [scaleVars.iconSize]: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
                readonly [buttonLabelLayoutVars.iconToTextPadding]: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
                readonly [buttonLabelLayoutVars.iconToEdgePadding]: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
                readonly [buttonLabelLayoutVars.textToEdgePadding]: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
            };
        };
        readonly sm: {
            readonly vars: {
...
export { variants, compoundVariants, styles, progressStyle };
