 ...
 */
export declare function ReorderableTabBarItem<K extends string | number>({ children, dragKey, setDragKey, onReorder, layout, rootRef, isFirstItem, isLastItem }: ReorderableTabBarItem<K>): import("preact").JSX.Element;
export {};
