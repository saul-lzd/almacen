 ...
 * @ignore
 */
import { type ComponentChildren, type ComponentProps, type Ref, type VNode } from 'preact';
...
type Props<K extends string | number, D extends Record<string, any>> = TestIdProps & {
     ...
     */
    collectionRenderer?: (collectionRendererProps: CollectionRendererProps<K, D>) => ComponentChildren;
    /**
...
export declare const SelectSingle: {
    <K extends string | number, D extends Record<string, any>>(props: Props<K, D> & {
        ref?: Ref<FocusableHandle>;
    }): VNode<any> | null;
};
export type SelectSingleProps<K extends string | number, D extends Record<string, any>> = Props<K, D>;
export {};
