...
export declare function getBarPosition<K extends string | number, D extends BarItemData<K>>(series: BarSeriesData<K, D>[], groups: Group[], getDataItem: (seriesIndex: number, groupIndex: number) => D | undefined, xScale: Scale, yScale: Scale, y2Scale: Scale, hiddenIds: Set<number | string> | undefined, dataItemGaps: number, axisStepWidth: number, averageGroupZ: number, barGapRatio: number, isLog: boolean, isStacked: boolean, isRtl: boolean, isHoriz: boolean, isSplitDualY: boolean, getStackGroup?: (s: ChartSeriesData<K, D>) => string | number | undefined, timeAxisType?: 'mixedFrequency' | 'enabled' | 'skipGaps'): (seriesIndex: number, groupIndex: number) => {
    x: number;
    y: number;
    width: number;
    height: number;
...
export declare function getSeriesOffsetAndWidth<K extends string | number, D extends BarItemData<K>>(axisStepWidth: number, averageGroupZ: number, series: ChartSeriesData<K, D>[], getDataItem: (seriesIndex: number, groupIndex: number) => D | undefined, barGapRatio: number, dataItemGaps: number, isStacked: boolean, isRtl: boolean, isHoriz: boolean): (seriesIndex: number, groupIndex: number) => {
    offset: number;
    dataWidth: number;
};
