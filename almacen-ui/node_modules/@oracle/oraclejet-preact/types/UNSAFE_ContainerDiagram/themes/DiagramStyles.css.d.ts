...
declare const buttonStyle: string;
declare const childContentStyle: string;
...
export { outerStyles, layerStyles, itemStyles, panZoomStyles, labelStyles, dimensionStyle, childContentStyle, buttonStyle };
