...
declare const styles: {
    readonly baseStyleDesktop: string;
    readonly baseStyleSmallWidth: string;
    ...
    readonly dialogContentStyleNoShrink: string;
    readonly dialogTitleStyle: string;
    readonly dialogHeaderStyle: string;
    readonly dialogHeaderStyleDesktop: string;
    readonly dialogHeaderStyleSmall: string;
    readonly dialogHeaderCloseIconStyle: string;
    readonly dialogHeaderDecorationStyle: string;
    readonly dialogBodyStyle: string;
    readonly dialogBodyStyleDesktop: string;
    readonly dialogBodyStyleSmall: string;
    readonly dialogFooterStyle: string;
    readonly dialogFooterStyleDesktop: string;
    readonly dialogFooterStyleSmall: string;
};
/*******************
 * Component Variants
 *******************/
