declare const dialogVars: {
    ...
    headerPaddingHorizontalSmall: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    ...
    bodyPaddingHorizontalSmall: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    ...
    footerPaddingBottomSmall: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    footerPaddingHorizontal: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
    footerPaddingHorizontalSmall: `var(--${string})` | `var(--${string}, ${string})` | `var(--${string}, ${number})`;
