...
export declare function BaseNavigationListItem<K extends string | number>({ itemKey, label, badge, metadata, severity, removeIcon, icon, href, 'aria-controls': ariaControls }: BaseNavigationListItemProps<K>): import("preact").JSX.Element;
export {};
