 ...
 */
export declare function ListViewContextMenu<K extends string | number, D>({ contextMenuConfig, testId, contextMenuContext, ...menuProps }: Props<K, D>): import("preact").JSX.Element | null;
