...
import { s as scaleVars, d as densityVars } from './themeContract.css-1ffed3bf.js';
import { r as rgb$1 } from './colorUtils-b3804ee8.js';

const rgb = (rgb) => rgb$1(rgb);
// TODO: create rgba function in PRIVATE_colorUtils
const rgba = (rgb, alpha) => `rgba(${rgb}, ${alpha})`;
const colorMix = (mixColor, mixPercent, baseColor) => `color-mix(in srgb, ${mixColor} ${mixPercent}, ${baseColor})`;
...
export { rgb as a, max as b, colorMix as c, densityUnits as d, fallbackVar as f, min as m, rgba as r, xUnits as x };
//# sourceMappingURL=utils-b1eb54f9.js.map
