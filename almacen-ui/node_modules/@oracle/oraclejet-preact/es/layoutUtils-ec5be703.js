...
const calculateOffset = (isRtl, width, bounds, isBottomStart, height) => {
    ...
    return {
        mainAxis: (isBottomStart ? 1 : -1) * center.y + DATATIP_OFFSET + (isBottomStart ? -1 * height : 0),
...
export { calculateOffsetForPicto as a, getUnion as b, calculateOffset as c, getRandomId as g, intersects as i };
//# sourceMappingURL=layoutUtils-ec5be703.js.map
