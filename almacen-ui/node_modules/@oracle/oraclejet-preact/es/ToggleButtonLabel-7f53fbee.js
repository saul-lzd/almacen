...
import { B as ButtonLabelLayout } from './ButtonLabelLayout-1631c997.js';
...
const ToggleButtonInput = ({ isDisabled, isChecked, isSwitch, inputName, inputType, value, inputId, startIcon, endIcon, display, onAction, size, label, onBlur, onFocus, onMouseEnter, onMouseLeave, onTouchEnd, onTouchStart }) => {
    ...
    return isLabel ? (jsxs("label", { for: inputId, class: wrapperClasses, onBlur: (event) => {
            onBlur?.(event);
        }, onFocus: (event) => {
            onFocus?.(event);
        }, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onTouchEnd: onTouchEnd, onTouchStart: onTouchStart, children: [label, inputElement] })) : (jsxs("label", { for: inputId, class: wrapperClasses, onBlur: (event) => {
            onBlur?.(event);
        }, onFocus: (event) => {
            onFocus?.(event);
        }, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onTouchEnd: onTouchEnd, onTouchStart: onTouchStart, children: [jsx(ButtonLabelLayout, { display: display, startIcon: startIcon, endIcon: endIcon, size: size, children: label }), inputElement, display === 'icons' ? jsx(HiddenAccessible, { children: label }) : undefined] }));
};
...
//# sourceMappingURL=ToggleButtonLabel-7f53fbee.js.map
