...
function VisNoDataMessage(props) {
    ...
    return (jsx(VisStatusMessage, { text: noDataMsg, width: props.width, height: props.height, "aria-label": props['aria-label'], "aria-describedby": props['aria-describedby'], "aria-labelledby": props['aria-labelledby'] }));
}

export { VisNoDataMessage };
