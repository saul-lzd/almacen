...
const DropdownMenu = forwardRef(({ anchorRef, defaultPlacement, offsetValue, closeSubmenu, children, 'aria-label': ariaLabel, currentFocus, menuId, menuLevel, flipOptions, isOpen, isMenuLoading = false, minWidth }, ref) => {
...
const Menu = ({ onClose, isOpen, testId, initialFocus = 'menu', placement, offsetValue, minWidthBehavior, anchorRef, flipOptions, ...menuProps }) => {
    ...
    }, [isOpen, minWidthBehavior, anchorWidth]);
...
//# sourceMappingURL=SelectMenuGroupContext-aa1fe822.js.map
