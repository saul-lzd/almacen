...
class ModalManager {
    constructor() {
         ...
         */
        this.browser = getClientHints().browser;
        this.isFirefox = () => {
...
const Modal = ({ children, isOpen, onBackdropClick, backdropVariant }) => {
    ...
    const logicalParentRef = useContext(LogicalParentRefContext);
    return isOpen ? (jsx(Layer, { isModal: true, logicalParentRef: logicalParentRef, children: jsxs("div", { ref: modalRef, class: baseStyle, onFocus: handleFocusIn, children: [jsx(ModalBackdrop, { ref: backdropRef, variant: backdropVariant }), children] }) })) : null;
};

export { LogicalParentRefContext as L, Modal as M };
//# sourceMappingURL=Modal-c0f730b8.js.map
