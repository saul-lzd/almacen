...
const bundle = {
    ...
    accButtonProgressComplete: (p) => 'Радња је у завршена: ' + p['label'],
    accButtonProgressStatus: (p) => 'Радња је у току: ' + p['label'],
    accColorPalette: () => 'Палета боја',
    accColorSwatch: () => 'Узорци боја',
    accCommandKey: () => 'Команда',
    accContextMenuLabel: () => 'радње',
    ...
    chart_labelX: () => 'X',
    chart_labelY: () => 'Y',
    checkboxSet_requiredMessageDetail: () => 'Изаберите вредност.',
    checkbox_helpForCheckbox: () => 'Помоћ за поље за потврду',
    checkbox_requiredMessageDetail: () => 'Изаберите вредност.',
    checkbox_selected: () => 'Поље за потврду је означено',
    checkbox_unselected: () => 'Поље за потврду није означено',
    close: () => 'Затвори',
    collection_apply: () => 'Примени',
    collection_cancel: () => 'Откажи',
    collection_loaded: () => 'Учитано',
    collection_loading: () => 'Учитава се',
    collection_noData: () => 'Нема података за приказ.',
    collection_pixels: () => 'пикс.',
    collection_resizeColumnDialog: () => 'Промена величине колоне',
    collection_resizeColumnMenu: () => 'Промена величине колоне...',
    collection_resizeMessageDetail: (p) => 'Унесите број између ' + p['MIN'] + ' и ' + p['MAX'] + '.',
    collection_selectAllRows: () => 'Изабери све редове',
    collection_selectRow: (p) => 'Изаберите ред ' + p['ROW_NAME'],
    collection_sortAscendingSubMenu: () => 'Растуће',
    collection_sortColumnMenu: () => 'Сортирај колоне',
    collection_sortDescendingSubMenu: () => 'Опадајуће',
    collection_sortDisabled: () => 'Не може да се сортира',
    collection_sortEnabled: () => 'Може да се сортира',
    collection_width: () => 'Ширина',
    colorPicker_label: () => 'Бирач боја',
    ...
    diagram_promotedLink: () => '1 веза',
    diagram_promotedLinkAriaDesc: () => 'Индиректно',
    diagram_promotedLinks: (p) => 'Број веза: ' + p['num_links'],
    error: () => 'Грешка',
    ...
    formControl_selectionExactMessageDetail: (p) => 'Изаберите ' + p['n'] + ' вредност(и).',
    formControl_selectionOverflowMessageDetail: (p) => 'Достигли сте ограничење за избор: ' + p['max'] + '.',
    formControl_selectionRangeMessageDetail: (p) => 'Изаберите од ' + p['min'] + ' до ' + p['max'] + ' вредности.',
    formControl_selectionUnderflowMessageDetail: (p) => 'Изаберите најмање ' + p['min'] + ' вредност(и).',
    ...
    info: () => 'Информације',
    inputColor_selectColor: () => 'Изаберите боју',
    ...
    inputTimeMask_timeRangeOverflowMessageDetail: (p) => 'Унесите време које је ' + p['max'] + ' или раније.',
    inputTimeMask_timeRangeUnderflowMessageDetail: (p) => 'Унесите време које је ' + p['min'] + ' или касније.',
    inputTimeMask_time_cleared: () => 'Време је обрисано',
    labelNone: () => 'Ниједно',
    list_msgFetchCompleted: () => 'Учитано',
    list_msgFetchingData: () => 'Учитава се',
    list_suggestion: () => 'Предлог',
    menu_stateLoading: () => 'Учитава се',
    ...
    message_navigationFromMessagesRegion: () => 'Прелазак на област за поруке. Притисните F6 да бисте се кретали.',
    message_navigationToMessagesRegion: () => 'У региону за поруке има нових порука. Притисните F6 да бисте се кретали.',
    message_navigationToTouch: () => 'У региону за поруке има нових порука.',
    message_warning: () => 'Упозорење',
    noData_message: () => 'Нема ставки за приказ',
    overflowItemLabel: () => 'Још картица',
    plural_separator: () => ', ',
    popup_close_skipLink: () => 'Двапут додирните да бисте затворили отворени искачући прозор.',
    popup_liveRegion_F6_initial_focus_firstFocusable: () => 'Прелазак у искачући прозор. Притисните F6 да бисте прелазили између искачућег прозора и повезане контроле.',
    popup_liveRegion_F6_initial_focus_none: () => 'Отворен је искачући прозор. Притисните F6 да бисте прелазили између искачућег прозора и повезане контроле.',
    progressIndeterminate: () => 'У току',
    radioButton_checked: () => 'Радио дугме је означено',
    radioButton_selected: () => 'Радио дугме је изабрано',
    radioButton_unchecked: () => 'Радио дугме није означено',
    radioButton_unselected: () => 'Радио дугме није изабрано',
    ...
    select_closeDropdown: () => 'Притисните тастер Escape да бисте затворили.',
    ...
    tabBar_tabContainsErrors: () => 'Садржи грешке',
    tabbar_accAnnounceRemovedKey: (p) => 'Уклоњено: ' + p['itemKey'],
    tabbar_labelContextMenu: () => 'има контекстуални мени',
    tabbar_labelMoveLeft: () => 'Помери налево',
    tabbar_labelMoveRight: () => 'Помери надесно',
    tabbar_labelRemove: () => 'Уклони',
    timeComponent_tooltipZoomIn: () => 'Увећај',
    timeComponent_tooltipZoomOut: () => 'Умањи',
    timeConverter_parseError: () => 'Унесите комплетно време.',
    ...
    vis_invalidData: () => 'Неважећи подаци',
    ...
    vis_stateCollapsed: () => 'Скупљено',
    vis_stateExpanded: () => 'Проширено',
