...
import { i as inSpace } from './utils-8e622bdf.js';
import { f as findSeriesGroupIndexFromId } from './utils-24c54d43.js';
        ...
        if (itemsDraggable && itemsDraggable(currentData, seriesIndex, groupIndex) == 'on') {
            ...
            if (selectedIds.size > 1 && selectedIds.has(currentData.id)) {
                ...
                while (current !== undefined) {
                    const { seriesIndex, groupIndex } = findSeriesGroupIndexFromId(series, current, levelsArray, getDataItem);
                    data.push({
                        data: getDataItem(seriesIndex, groupIndex, levelsArray[levelsArray.length - 1]?.[groupIndex].path),
                        seriesIndex,
                        groupIndex,
                        groupPath: levelsArray[levelsArray.length - 1]?.[groupIndex].path
                    });
...
export { useChartDnd as u };
//# sourceMappingURL=useChartDnd-aa8bc33b.js.map
