...
import { v as getLabelPosition, w as getGroupCenterCoord, x as getMarkerFillAndStroke } from './utils-24c54d43.js';
import { s as supportsMobileScreenReader } from './accUtils-9d5183c4.js';
...
function MarkerLabel({ labelPosition, label, labelStyle, tx, ty, defaultFontSize, dataLabelEffect, isHighContrast, getTextDimensions, isRtl }) {
    ...
    if (position && labelString) {
        ...
        const { x, y } = getLabelPosition(position, tx, ty, labelDims, isRtl);
...
export { MarkersWithLabel as M };
//# sourceMappingURL=MarkersWithLabel-a838355c.js.map
