...
import { i as isKeyDefined, c as containsKey, a as addKey, r as removeKey } from './keys-49c92dbb.js';
...
function useSelection(keyExtractor, selectedKeys, selectionMode, isSelectionRequired, selectionBehavior, onChange, anchorKey, currentKey, getVerticalPrevNextKey, getHorizontalPrevNextKey, scrollToKey, onRangeChange) {
    ...
    const pendingKeyboardSelectionCursor = useRef(false);
    ...
    const onKeyDown = useCallback((event) => {
        ...
        if (Object.keys(keyHandlers).includes(event.key)) {
            ...
            if (event.shiftKey &&
                ...
                if (!isKeyDefined(keyboardSelectionCursor.current) && isKeyDefined(currentKey)) {
...
//# sourceMappingURL=useSelection-65134722.js.map
