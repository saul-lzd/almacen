...
import { T as TabBar } from './TabBar-10488830.js';
...
import { a as getKey } from './collectionUtils-5313629f.js';
import { u as useUser } from './useUser-06d34d19.js';
import './LayerHost-7931b424.js';
import { a as useReorderableItem, u as useReorderable } from './useReorderableItem-857636b7.js';
...
import './TabBarContextMenu-c3326d67.js';
...
import './tabBarUtils-9102bb6e.js';
 ...
 */
function ReorderableTabBarItem({ children, dragKey, setDragKey, onReorder, layout, rootRef, isFirstItem, isLastItem }) {
    ...
    return (jsxs("div", { ...rootProps, draggable: onReorder ? true : false, "data-oj-draggable": onReorder ? '' : undefined, style: flexDimensions, children: [children, !isDragged && isKeyDefined(dragKey) && (jsxs(Fragment, { children: [jsx("div", { ...overlayZoneBeforeProps, class: overlayZoneBeforeClass }), jsx("div", { ...overlayZoneAfterProps, class: overlayZoneAfterClass })] }))] }));
}

/**
 * A component that allows reordering of tabs within a TabBar.
 */
const ReorderableTabBar = forwardRef(({ 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledby, children, layout = 'stretch', display = 'standard', size = 'md', edge = 'top', selection, onSelect, onRemove, onReorder, contextMenuConfig, testId }, ref) => {
    ...
    return (jsxs("div", { ref: rootRef, ...reorderProps, children: [jsx(ReorderableContext.Provider, { value: tabBarReorderContext, children: jsx(TabBar, { ref: ref, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, layout: layout, edge: edge, selection: selection, onSelect: onSelect, onRemove: onRemove, testId: testId, ...displayProps, "aria-describedby": reorderInstructionsId, contextMenuConfig: contextMenuConfig, children: childrenArray.map((child, idx) => {
                        return (jsx(ReorderableTabBarItem, { dragKey: dragKey, setDragKey: setDragKey, onReorder: onReorder, layout: layout, rootRef: rootRef, isFirstItem: idx === 0, isLastItem: idx === childrenArray.length - 1, children: child }));
