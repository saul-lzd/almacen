...
function useChartDataCursor({ touchResponse, findNearest, dataCursorPosition, onDataCursorPositionChange, isDataCursorEnabled, isHoriz, plotAreaSpace, yScale, y2Scale, xScale, dataCursorStyle, focusedItemInfo, getDataItemPos, getMarkerInfo }) {
    ...
    if (x != undefined && (y != undefined || y2 != undefined) && isDataCursorEnabled) {
        ...
        dataCursorContent = (jsxs(Fragment, { children: [jsxs("g", { class: styles.dataCursor, children: [jsx("line", { ...mainLineProps, class: styles.dataCursorLine }), jsx("line", { ...contrastLineProps, class: styles.contrastLine })] }), dataCursorStyle?.isMarkerDisplayed && info && (jsx(Marker, { type: markerType, tx: tx, ty: ty, isInteractive: true, scale: 1, fill: color, stroke: rgb(colorSchemeVars.palette.neutral[0]), outerStroke: color, width: markerDims, height: markerDims, preserveRectAspectRatio: true }))] }));
    }
    return {
        dataCursorContent,
...
//# sourceMappingURL=useChartDataCursor-f79f98ec.js.map
