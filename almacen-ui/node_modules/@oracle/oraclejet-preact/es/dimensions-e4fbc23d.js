...
import { i as isNil } from './colorUtils-b3804ee8.js';
...
// e.g., it maps 50x to calc(50 * var(--oj-c-size-units, 0.25rem));
const propToSize = (key) => (props) => {
    ...
    return isNil(props[key]) ? {} : { [key]: sizeToCSS(val) };
};
...
export { dimensions as a, dimensionInterpolations as d };
//# sourceMappingURL=dimensions-e4fbc23d.js.map
