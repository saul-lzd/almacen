...
const bundle = {
    ...
    accButtonProgressComplete: (p) => 'Dejanje ' + p['label'] + ' je dokončano',
    accButtonProgressStatus: (p) => 'Dejanje ' + p['label'] + ' je v teku',
    accColorPalette: () => 'Barvna paleta',
    accColorSwatch: () => 'Barvna paleta',
    accCommandKey: () => 'Ukaz',
    accContextMenuLabel: () => 'dejanja',
    accControlKey: () => 'Zapri',
    accPositionAfter: () => 'po',
    ...
    chart_labelX: () => 'X',
    chart_labelY: () => 'Y',
    checkboxSet_requiredMessageDetail: () => 'Izberite vrednost.',
    checkbox_helpForCheckbox: () => 'Pomoč za potrditveno polje',
    checkbox_requiredMessageDetail: () => 'Izberite vrednost.',
    checkbox_selected: () => 'Potrditveno polje je označeno',
    checkbox_unselected: () => 'Potrditveno polje ni označeno',
    close: () => 'Zapri',
    collection_apply: () => 'Dodeli',
    collection_cancel: () => 'Prekliči',
    collection_loaded: () => 'Naloženo',
    collection_loading: () => 'Nalaganje',
    collection_noData: () => 'Ni podatkov za prikaz.',
    collection_pixels: () => 'piksli',
    collection_resizeColumnDialog: () => 'Sprememba velikosti stolpca',
    collection_resizeColumnMenu: () => 'Spremeni velikost stolpca...',
    collection_resizeMessageDetail: (p) => 'Vnesite število med ' + p['MIN'] + ' in ' + p['MAX'] + '.',
    collection_selectAllRows: () => 'Izbira vseh vrstic',
    collection_selectRow: (p) => 'Izbira vrstice ' + p['ROW_NAME'],
    collection_sortAscendingSubMenu: () => 'Naraščajoče',
    collection_sortColumnMenu: () => 'Razvrsti stolpec',
    collection_sortDescendingSubMenu: () => 'Padajoče',
    collection_sortDisabled: () => 'Ni razvrstljivo',
    collection_sortEnabled: () => 'Razvrstljivo',
    collection_width: () => 'Širina',
    colorPicker_label: () => 'Izbirnik barve',
    ...
    diagram_promotedLink: () => 'Št. povezav: 1',
    diagram_promotedLinkAriaDesc: () => 'Posredno',
    diagram_promotedLinks: (p) => 'Št. povezav: ' + p['num_links'],
    error: () => 'Napaka',
    ...
    formControl_selectionExactMessageDetail: (p) => 'Izberite ' + p['n'] + ' vrednosti.',
    formControl_selectionOverflowMessageDetail: (p) => 'Dosegli ste omejitev izbire, ki je ' + p['max'] + '.',
    formControl_selectionRangeMessageDetail: (p) => 'Izberite ' + p['min'] + ' do ' + p['max'] + ' vrednosti.',
    formControl_selectionUnderflowMessageDetail: (p) => 'Izberite vsaj ' + p['min'] + ' vrednosti.',
    ...
    info: () => 'Informacije',
    inputColor_selectColor: () => 'Izberite barvo',
    ...
    inputTimeMask_timeRangeOverflowMessageDetail: (p) => 'Vnesite čas, ki je ob ' + p['max'] + ' ali pred tem.',
    inputTimeMask_timeRangeUnderflowMessageDetail: (p) => 'Vnesite čas, ki je ob ' + p['min'] + ' ali pozneje.',
    inputTimeMask_time_cleared: () => 'Čas počiščen',
    labelNone: () => 'Brez',
    list_msgFetchCompleted: () => 'Naloženo',
    list_msgFetchingData: () => 'Nalaganje',
    list_suggestion: () => 'Predlog',
    menu_stateLoading: () => 'Nalaganje',
    ...
    message_navigationFromMessagesRegion: () => 'Vstopanje v področje sporočil. Pritisnite F6 za krmarjenje.',
    message_navigationToMessagesRegion: () => 'Področje sporočil ima nova sporočila. Pritisnite F6 za krmarjenje.',
    message_navigationToTouch: () => 'Področje sporočil ima nova sporočila.',
    message_warning: () => 'Opozorilo',
    noData_message: () => 'Ni elementov za prikaz',
    overflowItemLabel: () => 'Več zavihkov',
    plural_separator: () => ', ',
    popup_close_skipLink: () => 'Dvakrat tapnite, da se odprti pojavni element zapre.',
    popup_liveRegion_F6_initial_focus_firstFocusable: () => 'Vstopanje v pojavni element. Pritisnite F6 za krmarjenje med pojavnim elementom in povezano kontrolo.',
    popup_liveRegion_F6_initial_focus_none: () => 'Pojavni element je odprt. Pritisnite F6 za krmarjenje med pojavnim elementom in povezano kontrolo.',
    progressIndeterminate: () => 'V teku',
    radioButton_checked: () => 'Izbirni gumb označen',
    radioButton_selected: () => 'Izbirni gumb izbran',
    radioButton_unchecked: () => 'Izbirni gumb ni označen',
    radioButton_unselected: () => 'Izbirni gumb ni izbran',
    ...
    select_closeDropdown: () => 'Pritisnite tipko Escape za zapiranje.',
    ...
    sheet_close: () => 'Zapri',
    switch_off: () => 'Izklopljeno',
    switch_on: () => 'Vklopljeno',
    tabBarNavigationList_removeCueText: () => 'Odstranljivo',
    tabBar_tabContainsErrors: () => 'Vsebuje napake',
    tabbar_accAnnounceRemovedKey: (p) => 'Odstranjeno: ' + p['itemKey'],
    tabbar_labelContextMenu: () => 'ima priročni meni',
    tabbar_labelMoveLeft: () => 'Premakni levo',
    tabbar_labelMoveRight: () => 'Premakni desno',
    tabbar_labelRemove: () => 'Odstrani',
    timeComponent_tooltipZoomIn: () => 'Povečava',
    timeComponent_tooltipZoomOut: () => 'Pomanjšava',
    timeConverter_parseError: () => 'Vnesite čas dokončanja.',
    ...
    vis_invalidData: () => 'Neveljavni podatki',
    ...
    vis_stateCollapsed: () => 'Strnjeno',
    vis_stateExpanded: () => 'Razširjeno',
