...
const restoreFocusForCleanup = (focusTarget) => {
    if (focusTarget) {
        const isElement = focusTarget instanceof HTMLElement || focusTarget instanceof SVGElement;
        if (!isElement || tabbableUtils.isTabbableElement(focusTarget)) {
            setTimeout(() => {
                tabbableUtils.focusOn(focusTarget);
            }, 0);
        }
    }
};
...
//# sourceMappingURL=FocusTrap-4873a3f2.js.map
