...
var useRadioFocusManager = require('./useRadioFocusManager-a11750e7.js');
 ...
 */
const RichRadioSet = compat.forwardRef(({ children, onCommit, value, isDisabled: propIsDisabled, isReadonly: propIsReadonly, ...otherProps }, ref) => {
    const baseId = useId.useId();
    const { isDisabled: isFormDisabled, isReadonly: isFormReadonly } = useFormContext.useFormContext();
    ...
    return (jsxRuntime.jsx(RadioItemContext.RadioSetContext.Provider, { value: {
            name: baseId,
            value,
            onCommit,
            setFocusIndex
        }, children: jsxRuntime.jsx(TabbableModeContext.TabbableModeContext.Provider, { value: { isTabbable: isFocused && isReadonly ? false : isTabbable }, children: jsxRuntime.jsx("div", { ref: containerRef, onKeyDown: isReadonly ? handleArrowKeyPress : undefined, ...(isReadonly ? focusProps : {}), children: jsxRuntime.jsx(BaseRichSelection.BaseRichSelection, { ...otherProps, isDisabled: propIsDisabled, isReadonly: propIsReadonly, baseId: baseId, ref: ref, selection: "single", value: value, children: preact.toChildArray(children).map((child, index) => (
                    // index is needed for keyboard navigation with radio items
                    jsxRuntime.jsx(RadioItemContext.RadioItemContext.Provider, { value: { index }, children: child }))) }) }) }) }));
});
