...
var ComponentMessageContainer = require('./ComponentMessageContainer-b692adf3.js');
...
function InlineUserAssistance({ assistiveText, fieldLabel, helpSourceLink, helpSourceText, id, isRequiredShown, requiredAlignment, messages = [], showInlineAssistanceOn = 'focus', userAssistanceDensity, testId }) {
    ...
    const uaInlineContent = messages.length > 0 ? (jsxRuntime.jsx(ComponentMessageContainer.ComponentMessageContainer, { fieldLabel: fieldLabel, messages: messages })) : (assistiveText || helpSourceLink) && (showInlineAssistanceOn === 'always' || isFocused) ? (jsxRuntime.jsx(InlineHelp.InlineHelp, { assistiveText: assistiveText, sourceLink: helpSourceLink, sourceText: helpSourceText })) : isRequiredShown ? (jsxRuntime.jsx(InlineRequired, { align: requiredAlignment })) : null;
...
//# sourceMappingURL=InlineUserAssistance-cfaa3d3e.js.map
