...
const useContextMenuGesture = (onContextMenuHandler, contextMenuOptions = {
    ...
    const onContextMenu = hooks.useCallback((event) => {
        ...
        if (!getIsSelectionPending() || !allowBrowserContextMenu) {
    ...
    }, [onContextMenuHandler, getIsSelectionPending, touchGestureType, allowBrowserContextMenu]);
...
//# sourceMappingURL=useContextMenuGesture-530ef8dd.js.map
