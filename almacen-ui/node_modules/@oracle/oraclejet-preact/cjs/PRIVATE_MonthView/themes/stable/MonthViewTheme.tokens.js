...
const monthViewColorSchemeDefault = {
    dayOfTheWeek: {
        color: themeContract_css.colorSchemeVars.textIcon.secondary
    }
};
...
const monthViewScaleSchemeDefault = {
    ...
    dayOfTheWeek: {
        lineHeight: `calc(2 * ${themeContract_css.typographyVars.body.xs.fontSize})`,
        fontSize: themeContract_css.typographyVars.body.xs.fontSize,
        fontWeight: themeContract_css.typographyVars.body.xs.fontWeight.semibold
    }
};
// scale lg extensions
