...
const ToggleButtonInput = ({ isDisabled, isChecked, isSwitch, inputName, inputType, value, inputId, startIcon, endIcon, display, onAction, size, label, onBlur, onFocus, onMouseEnter, onMouseLeave, onTouchEnd, onTouchStart }) => {
    ...
    return isLabel ? (jsxRuntime.jsxs("label", { for: inputId, class: wrapperClasses, onBlur: (event) => {
            onBlur?.(event);
        }, onFocus: (event) => {
            onFocus?.(event);
        }, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave, onTouchEnd: onTouchEnd, onTouchStart: onTouchStart, children: [label, inputElement] })) : (jsxRuntime.jsxs("label", { for: inputId, class: wrapperClasses, onBlur: (event) => {
            onBlur?.(event);
        }, onFocus: (event) => {
            onFocus?.(event);
...
//# sourceMappingURL=ToggleButtonLabel-c8f36317.js.map
