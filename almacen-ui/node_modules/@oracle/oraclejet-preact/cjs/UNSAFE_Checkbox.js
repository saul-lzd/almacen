...
var CheckboxControl = require('./CheckboxControl-d37c7764.js');
 ...
 */
const Checkbox = compat.forwardRef(({ 'aria-describedby': propAriaDescribedBy, assistiveText, columnSpan, helpSourceLink, helpSourceText, isDisabled: propIsDisabled, isReadonly: propIsReadonly, isRequired = false, messages, onCommit, userAssistanceDensity: propUserAssistanceDensity, value: propValue, testId, children }, ref = null) => {
    ...
    const ariaDescribedBy = hasBottomUserAssistance
        ? stringUtils.l([bottomUaId, propAriaDescribedBy])
        : propAriaDescribedBy;
    ...
    // 
    return (jsxRuntime.jsx("div", { ...testIdProps, children: jsxRuntime.jsxs(CheckboxRadioContext.CheckboxRadioContext.Provider, { value: { isFocusRingShown: !isDisabled }, children: [jsxRuntime.jsx(CheckboxControl.CheckboxControl, { ...(!isDisabled && !isReadonly
                        ? {
                            onChange: onChangeHandler,
                            onKeyUp: onChangeHandler
                        }
                        : {}), "aria-describedby": ariaDescribedBy, assistiveText: assistiveText, columnSpan: columnSpan, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isChecked: propValue, isDisabled: isDisabled, isReadonly: isReadonly, isRequired: isRequired, ref: checkboxRef, children: children }), hasBottomUserAssistance ? (jsxRuntime.jsx(InlineUserAssistance.InlineUserAssistance, { id: bottomUaId, isRequiredShown: !isReadonly && !!isRequired && !propValue, requiredAlignment: "start", messages: messages, userAssistanceDensity: userAssistanceDensity === 'reflow' ? 'reflow' : 'efficient', testId: UAtestId })) : userAssistanceDensity === 'reflow' ? undefined : (
