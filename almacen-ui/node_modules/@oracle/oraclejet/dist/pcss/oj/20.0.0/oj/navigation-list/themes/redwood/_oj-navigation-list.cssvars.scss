...
:root {
  ...
  --oj-private-navigation-list-item-border-bottom-width:   3px;
  --oj-private-navigation-list-item-border-height:         2.5rem;

  --oj-navigation-list-item-padding:                       0;
  --oj-navigation-list-indent-width:                       0;
  ...
  --oj-navigation-list-item-border-color-selected:             var(--oj-core-text-color-primary);
