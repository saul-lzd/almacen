...
//  For table in list mode and listview
  ...
  // cell readonly
  --oj-collection-editable-cell-bg-color-read-only:        var(--oj-core-color-disabled-1);

  // icon
  --oj-collection-default-sort-icon-display:               block;

  // focus ring
  --oj-private-collection-focus-border-style:              dotted;
  --oj-private-collection-focus-border-width:                 1px;
  --oj-private-collection-focus-border-inset:                -1px;
  --oj-private-collection-focus-border-offset:                1px;
}
