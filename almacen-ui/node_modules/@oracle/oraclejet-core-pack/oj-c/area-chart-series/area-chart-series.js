define(["require", "exports", '@oracle/oraclejet-preact/translationBundle', "ojs/ojvcomponent"], function (require, exports, translationBundle_1, ojvcomponent_1) {
    ...
    ...props }) => {
        return null;
    }, "AreaChartSeries", { "properties": { "assignedToY2": { "type": "string", "enumValues": ["off", "on"] }, "categories": { "type": "Array<string>" }, "color": { "type": "string" }, "areaColor": { "type": "string" }, "drilling": { "type": "string", "enumValues": ["off", "inherit", "on"] }, "lineType": { "type": "string", "enumValues": ["curved", "straight"] }, "markerShape": { "type": "string", "enumValues": ["auto", "square", "circle", "diamond", "human", "plus", "star", "triangleDown", "triangleUp"] }, "markerColor": { "type": "string" }, "markerDisplayed": { "type": "string" }, "markerSize": { "type": "number" }, "name": { "type": "string" }, "shortDesc": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" } } }, { "drilling": "inherit" }, {
