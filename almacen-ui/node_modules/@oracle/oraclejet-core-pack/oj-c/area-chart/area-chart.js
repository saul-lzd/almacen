define(["require", "exports", "preact/jsx-runtime", '@oracle/oraclejet-preact/translationBundle', "preact/hooks", "@oracle/oraclejet-preact/UNSAFE_VisProgressiveLoader", "@oracle/oraclejet-preact/UNSAFE_LineAreaChart", "@oracle/oraclejet-preact/UNSAFE_VisNoDataMessage", "@oracle/oraclejet-preact/UNSAFE_Legend", "@oracle/oraclejet-preact/UNSAFE_ChartWithLegend", "@oracle/oraclejet-preact/hooks/UNSAFE_useBusyStateContext", "@oracle/oraclejet-preact/hooks/UNSAFE_useLegendPreferredSize", "@oracle/oraclejet-preact/UNSAFE_TrackResizeContainer", "@oracle/oraclejet-preact/hooks/UNSAFE_useUser", "ojs/ojvcomponent", "../hooks/UNSAFE_useChartData/useChartData", "../utils/PRIVATE_chartUtils/events", "../utils/PRIVATE_chartUtils/legendUtils", "../utils/PRIVATE_chartUtils/datatipUtil", "../hooks/UNSAFE_useVizCategories/useVizCategories", "../utils/PRIVATE_chartUtils/lineAreaUtils", "../utils/PRIVATE_chartUtils/plotAreaUtils", "../utils/PRIVATE_chartUtils/axisUtils", "../utils/PRIVATE_chartUtils/viewportUtils", "../utils/PRIVATE_chartUtils/preferredSizeUtils", "oj-c/hooks/PRIVATE_useVisContextMenu/useVisContextMenu", "oj-c/utils/PRIVATE_vizUtils/VisInvalidDataErrorBoundary", "preact/compat", "css!oj-c/area-chart/area-chart-styles.css"], function (require, exports, jsx_runtime_1, translationBundle_1, hooks_1, UNSAFE_VisProgressiveLoader_1, UNSAFE_LineAreaChart_1, UNSAFE_VisNoDataMessage_1, UNSAFE_Legend_1, UNSAFE_ChartWithLegend_1, UNSAFE_useBusyStateContext_1, UNSAFE_useLegendPreferredSize_1, UNSAFE_TrackResizeContainer_1, UNSAFE_useUser_1, ojvcomponent_1, useChartData_1, events_1, legendUtils_1, datatipUtil_1, useVizCategories_1, lineAreaUtils_1, plotAreaUtils_1, axisUtils_1, viewportUtils_1, preferredSizeUtils_1, useVisContextMenu_1, VisInvalidDataErrorBoundary_1, compat_1) {
    "use strict";
     ...
     *
     * <p>
     *  If your application has custom keyboard and touch shortcuts implemented for the component, these shortcuts can conflict with those of the component.
     *  It is the application's responsibility to disclose these custom shortcuts, possibly via a datatip or help popup.
     * </p>
     * <p>
    ...
    function AreaChartImpl({ data, hideAndShowBehavior = 'none', orientation = 'vertical', xAxis, yAxis, y2Axis, hoverBehavior = 'none', valueFormats, plotArea, zoomAndScroll, itemTemplate, seriesTemplate, groupTemplate, datatipTemplate, datatipConfig, seriesComparator, groupComparator, drilling = 'off', hiddenCategories = HIDDEN_DEFAULT, highlightedCategories = HIGHLIGHTED_DEFAULT, highlightMatch = 'any', selection = SELECTION_DEFAULT, selectionMode = 'none', timeAxisType, stack = 'off', legend = LEGEND_DEFAULT, contextMenuConfig, onOjContextMenuAction, onOjContextMenuSelection, onSelectionChanged, splitterPosition = 0.5, splitDualY = 'off', ...props }, ref) {
        ...
        const { series, groups, preactSeries, isLoading, idToDPItemMap, createGroupContext } = (0, useChartData_1.useChartData)(data, busyStateContext.addBusyState, itemTemplate, seriesTemplate, groupTemplate, 'oj-c-area-chart-item', 'oj-c-area-chart-series', 'oj-c-area-chart-group', seriesComparator, groupComparator, props.styleDefaults, 'area');
        ...
        const areaChartSizeRef = (0, hooks_1.useRef)(null);
        ...
        (0, hooks_1.useImperativeHandle)(ref, () => ({
            _getYAxis: () => {
                const axis = areaChartSizeRef.current?._getYaxis();
                if (!axis || !axis.bounds)
                    return axis;
                return { ...axis, bounds: (0, preferredSizeUtils_1.adjustForLegendOffset)(axis.bounds, chartOffsetRef.current) };
            },
            _getXAxis: () => {
                const axis = areaChartSizeRef.current?._getXaxis?.();
                if (!axis || !axis.bounds)
                    return axis;
                return { ...axis, bounds: (0, preferredSizeUtils_1.adjustForLegendOffset)(axis.bounds, chartOffsetRef.current) };
            },
            _getY2Axis: () => {
                const axis = areaChartSizeRef.current?._getY2axis();
                if (!axis || !axis.bounds)
                    return axis;
                return { ...axis, bounds: (0, preferredSizeUtils_1.adjustForLegendOffset)(axis.bounds, chartOffsetRef.current) };
            }
        ...
        return ((0, jsx_runtime_1.jsx)(ojvcomponent_1.Root, { ref: rootRef, children: (0, jsx_runtime_1.jsx)(UNSAFE_TrackResizeContainer_1.TrackResizeContainer, { width: "100%", height: "100%", children: (_width, _height) => {
                    ...
                    return ((0, jsx_runtime_1.jsx)(UNSAFE_VisProgressiveLoader_1.VisProgressiveLoader, { isLoading: isLoading, type: "area", "aria-label": props['aria-label'], "aria-describedBy": props['aria-describedby'], "aria-labelledBy": props['aria-labelledby'], children: (0, jsx_runtime_1.jsx)(VisInvalidDataErrorBoundary_1.VisInvalidDataErrorBoundary, { "aria-label": props['aria-label'], "aria-describedby": props['aria-describedby'], "aria-labelledby": props['aria-labelledby'], dependencies: [timeAxisType, series, groups, getDataItem], children: (0, jsx_runtime_1.jsx)(UNSAFE_ChartWithLegend_1.ChartWithLegend, { chart: chart, position: legendPosition, isRtl: isRtl, legend: chartLegend }) }) }));
                } }) }));
    }
