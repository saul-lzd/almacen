define(["require", "exports", "preact/jsx-runtime", '@oracle/oraclejet-preact/translationBundle', "@oracle/oraclejet-preact/UNSAFE_FormLayout", "@oracle/oraclejet-preact/hooks/UNSAFE_useFormVariantContext", "@oracle/oraclejet-preact/utils/UNSAFE_styles/Layout", "ojs/ojvcomponent", "ojs/ojcustomelement-registry", "css!oj-c/form-layout/form-layout-styles.css"], function (require, exports, jsx_runtime_1, translationBundle_1, UNSAFE_FormLayout_1, UNSAFE_useFormVariantContext_1, Layout_1, ojvcomponent_1, ojcustomelement_registry_1) {
    "use strict";
    ...
    // Propagate 'default' FormVariantContext to children in our default slot
    // **** must run AFTER the custom element registration above ****
    const metadata = (0, ojcustomelement_registry_1.getMetadata)('oj-c-form-layout');
    if (metadata && metadata.extension) {
        metadata.extension._BINDING = {
            provide: new Map([[UNSAFE_useFormVariantContext_1.FormVariantContext, 'default']])
        };
    }
});
