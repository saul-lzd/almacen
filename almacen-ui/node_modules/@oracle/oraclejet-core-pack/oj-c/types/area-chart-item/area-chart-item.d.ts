export type AreaChartItemImplProps = {
    ...
    /**
     * @description
     * The description of this object. This is used for accessibility and also for customizing the datatip text.
...
export namespace CAreaChartItemElement {
    ...
    type labelChanged = JetElementCustomEventStrict<CAreaChartItemElement['label']>;
    type markerColorChanged = JetElementCustomEventStrict<CAreaChartItemElement['markerColor']>;
...
export interface CAreaChartItemElementEventMap extends HTMLElementEventMap {
    ...
    'labelChanged': JetElementCustomEventStrict<CAreaChartItemElement['label']>;
    'markerColorChanged': JetElementCustomEventStrict<CAreaChartItemElement['markerColor']>;
...
export interface CAreaChartItemElementSettableProperties extends JetSettableProperties {
     ...
     * The label of the data item.
     */
    label?: AreaChartItemImplProps['label'];
    /**
     * The color of the data markers, if different from the series color.
     */
    markerColor?: AreaChartItemImplProps['markerColor'];
    /**
     * Defines whether the data marker is displayed. If auto, the markers will be displayed whenever the data points are not connected by a line.
     */
...
export interface AreaChartItemIntrinsicProps extends Partial<Readonly<CAreaChartItemElementSettableProperties>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    onlabelChanged?: (value: CAreaChartItemElementEventMap['labelChanged']) => void;
    onmarkerColorChanged?: (value: CAreaChartItemElementEventMap['markerColorChanged']) => void;
