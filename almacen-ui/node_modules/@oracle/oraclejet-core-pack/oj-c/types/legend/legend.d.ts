...
export type Section<K> = {
    ...
    /**
     * @description
     *The items of the legend section.
     */
    items: Item<K>[];
    /**
     * @description
...
export type DatatipTemplateContext<K, D> = {
    ...
    /**
     * @description
     * The id of the hovered item.
     */
    id: K;
    /**
     * @description
     * The row data object for the hovered item. This will only be set if a DataProvider is being used.
     */
    itemData: D;
    /**
     * @description
     * The id of the hovered section.
     */
    sectionId?: K;
    /**
     * @description
     * The sectionData of the hovered item.
     */
    sectionData?: Section<K>;
};
/**
 ...
 */
export declare const SectionalLegend: <K extends string | number, D extends Item<K> | Section<K> | object | any>({ hoverBehavior, hideAndShowBehavior, hiddenCategories, highlightedCategories, onHiddenCategoriesChanged, onHighlightedCategoriesChanged, drilling, itemTemplate, sectionTemplate, textStyle, sectionTitleStyle, orientation, symbolHeight, symbolWidth, valign, halign, contextMenuConfig, onOjContextMenuAction, onOjContextMenuSelection, ...props }: SectionalLegendProps<K, D>) => import("preact").JSX.Element | null;
export {};
...
declare namespace _CLegendElementTypes {
    type _DatatipTemplateContext<K extends string | number, D extends Item<K> | Section<K> | any> = DatatipTemplateContext<K, D>;
}
export namespace CLegendElement {
    ...
    type datatipConfigChanged<K extends string | number, D extends Item<K> | Section<K> | any> = JetElementCustomEventStrict<CLegendElement<K, D>['datatipConfig']>;
    ...
    type DatatipTemplateContext<K extends string | number, D extends Item<K> | Section<K> | any> = _CLegendElementTypes._DatatipTemplateContext<K, D>;
    type RenderDatatipTemplate<K extends string | number, D extends Item<K> | Section<K> | any> = import('ojs/ojvcomponent').TemplateSlot<DatatipTemplateContext<K, D>>;
}
export interface CLegendElementEventMap<K extends string | number, D extends Item<K> | Section<K> | any> extends HTMLElementEventMap {
    ...
    'datatipConfigChanged': JetElementCustomEventStrict<CLegendElement<K, D>['datatipConfig']>;
...
export interface CLegendElementSettableProperties<K, D extends Item<K> | Section<K> | any> extends JetSettableProperties {
     ...
     * The DatatipConfig object is used to allow applications to control the appearance and behavior of the datatip.
     */
    datatipConfig?: LegendProps<K, D>['datatipConfig'];
    /**
     * Whether drilling is enabled on all legend items.
     * Drillable objects will show a background opacity, a pointer cursor on hover, and fire ojDrill event on click.
     */
...
export interface LegendIntrinsicProps extends Partial<Readonly<CLegendElementSettableProperties<any, any>>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    ondatatipConfigChanged?: (value: CLegendElementEventMap<any, any>['datatipConfigChanged']) => void;
