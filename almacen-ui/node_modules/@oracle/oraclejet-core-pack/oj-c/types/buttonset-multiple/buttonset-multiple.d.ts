 ...
 * ]
 */
declare function ButtonsetMultipleImpl({ chroming, disabled, value, onValueChanged, size, width, maxWidth, layoutWidth, items, display, 'aria-label': accessibleLabel, 'aria-describedby': ariaDescribedBy, 'aria-labelledby': ariaLabelledBy, ...otherProps }: Props, ref: Ref<ButtonsetMultipleHandle>): import("preact").JSX.Element;
/**
