 ...
 * </p>
 *
 * @ojmetadata displayName "Input Time Mask"
 ...
 * ]
 */
declare const InputTimeMaskImpl: ({ columnSpan, containerReadonly: propContainerReadonly, disabled, displayOptions, granularity, leadingZeroForHour, help, helpHints, hourClock, labelWrapping: propLabelWrapping, max: propMax, min: propMin, messagesCustom, readonly: propReadonly, readonlyUserAssistanceShown, required, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, validators, value, ...otherProps }: Props, ref: Ref<InputTimeMaskHandle>) => import("preact").JSX.Element;
/**
