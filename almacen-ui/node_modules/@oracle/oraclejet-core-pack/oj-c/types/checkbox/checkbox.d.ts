...
export namespace CCheckboxElement {
    ...
    type validChanged = JetElementCustomEventStrict<Parameters<Required<CheckboxProps>['onValidChanged']>[0]>;
...
export interface CCheckboxElementEventMap extends HTMLElementEventMap {
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<CheckboxProps>['onValidChanged']>[0]>;
