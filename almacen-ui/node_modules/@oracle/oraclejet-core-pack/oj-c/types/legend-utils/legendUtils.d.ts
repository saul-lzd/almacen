 ...
 * @return {Object} An object containing preferred width and height required by legend to render and it returns undefined for when the element is not attached to the dom.
 * */
