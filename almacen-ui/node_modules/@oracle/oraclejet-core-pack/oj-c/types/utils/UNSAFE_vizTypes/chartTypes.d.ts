...
export type ViewPortDetail = {
    ...
    yMin?: number;
    /**
     * The maximum y2 value of the new viewport.
     * @ojmetadata description "The maximum y value of the new viewport."
     */
    y2Max?: number;
    /**
     * The minimum y2 value of the new viewport.
     * @ojmetadata description "The minimum y value of the new viewport."
     */
    y2Min?: number;
};
...
export type YAxis = {
    ...
    step?: number;
    /**
     * Specifies the size of the axis as a ratio from 0 to 1, based on the width (for horizontal) or height (for vertical) of the chart.
    ...
    size?: number;
    /**
     * Specifies the maximum size of the axis as a ratio from 0 to 1: axis width divided by chart width (for horizontal axes) or axis height divided by chart height (for vertical axes).
     ...
     * @ojmetadata description "The maximum size of the axis."
     * @ojmetadata displayName "Max Size"
     */
    maxSize?: number;
    /**
...
export type ValueFormats = {
    /**
     * Object that specifies the tooltip behavior for the group.
     * @ojmetadata description "The object defining the tooltip behavior for the group."
     */
    group: TextValueFormat;
    /**
     * Object that specifies the tooltip behavior for the series.
     * @ojmetadata description "The object defining the tooltip behavior for the series."
     */
    ...
    /**
     * Object that specifies the value formatting and tooltip behavior for the y2 values.
     * @ojmetadata description "The object defining formatting and tooltip behavior for the y2 values."
     */
    y2: NumericalValueFormat;
    /**
     * Object that specifies the tooltip behavior for the data item labels.
     * @ojmetadata description "The object defining the tooltip behavior for the data item labels."
     */
    label: TextValueFormat;
};
