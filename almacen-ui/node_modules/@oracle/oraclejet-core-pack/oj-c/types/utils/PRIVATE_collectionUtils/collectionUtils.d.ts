 ...
 */
export declare const getSelectedKeys: <K extends string | number, D>(selected: ImmutableKeySet<K> | undefined, listData: DataState<K, D> | undefined, selectionMode: string | undefined, onSelectedChanged: PropertyChanged<ImmutableKeySet<K>> | undefined) => {
    all: true;
    keys?: never;
