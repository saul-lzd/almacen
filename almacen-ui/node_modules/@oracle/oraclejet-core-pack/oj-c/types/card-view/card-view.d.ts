...
export namespace CCardViewElement {
    ...
    type currentItemChanged<K extends string | number, D> = JetElementCustomEventStrict<Parameters<Required<Props<K, D>>['onCurrentItemChanged']>[0]>;
...
export interface CCardViewElementEventMap<K extends string | number, D> extends HTMLElementEventMap {
    ...
    'currentItemChanged': JetElementCustomEventStrict<Parameters<Required<Props<K, D>>['onCurrentItemChanged']>[0]>;
