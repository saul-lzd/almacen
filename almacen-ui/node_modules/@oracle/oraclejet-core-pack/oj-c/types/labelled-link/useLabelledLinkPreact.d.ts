 ...
 */
export declare function useLabelledLinkPreact({ 'aria-describedby': ariaDescribedBy, href, labelEdge, labelHint, labelStartWidth, lineClamp, target, text, textAlign, userAssistanceDensity, onOjAction }: LabelledLinkProps): PreactLabelledLinkProps;
export {};
