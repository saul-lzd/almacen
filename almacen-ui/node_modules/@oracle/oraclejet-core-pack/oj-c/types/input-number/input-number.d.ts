...
type Props = ObservedGlobalProps<'aria-describedby' | 'id'> & {
     ...
     *
     * @ojmetadata description "Overrides the default NumberRangeValidator's overflow message detail."
     * @ojmetadata displayName "Number Range Overflow Message Detail"
     * @ojmetadata help "#numberRangeOverflowMessageDetail"
     * @ojmetadata translatable
     */
     ...
     *
     * @ojmetadata description "Overrides the default NumberRangeValidator's underflow message detail."
     * @ojmetadata displayName "Number Range Underflow Message Detail"
     * @ojmetadata help "#numberRangeUnderflowMessageDetail"
     * @ojmetadata translatable
     */
 ...
 * </p>
 *
 * @ojmetadata displayName "Input Number"
...
export namespace CInputNumberElement {
    ...
    type transientValueChanged = JetElementCustomEventStrict<Parameters<Required<Props>['onTransientValueChanged']>[0]>;
...
export interface CInputNumberElementEventMap extends HTMLElementEventMap {
    ...
    'transientValueChanged': JetElementCustomEventStrict<Parameters<Required<Props>['onTransientValueChanged']>[0]>;
