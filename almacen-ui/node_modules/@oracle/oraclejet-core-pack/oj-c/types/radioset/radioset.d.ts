...
export namespace CRadiosetElement {
    ...
    type validChanged<V extends string | number, D extends RadiosetDataItem> = JetElementCustomEventStrict<Parameters<Required<RadiosetProps<V, D>>['onValidChanged']>[0]>;
...
export interface CRadiosetElementEventMap<V extends string | number, D extends RadiosetDataItem> extends HTMLElementEventMap {
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<RadiosetProps<V, D>>['onValidChanged']>[0]>;
