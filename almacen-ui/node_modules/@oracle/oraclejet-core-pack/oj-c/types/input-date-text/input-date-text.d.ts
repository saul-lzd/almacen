 ...
 * </p>
 *
 * @ojmetadata displayName "Input Date Text"
 ...
 * ]
 */
declare const InputDateTextImpl: ({ autocomplete, columnSpan, containerReadonly: propContainerReadonly, converter, disabled, displayOptions, help, helpHints, id, labelWrapping: propLabelWrapping, max: propMax, min: propMin, messagesCustom, readonly: propReadonly, readonlyUserAssistanceShown, required, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, validators, value, ...otherProps }: Props, ref: Ref<InputDateTextHandle>) => import("preact").JSX.Element;
/**
