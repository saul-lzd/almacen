...
type Props = ObservedGlobalProps<'aria-describedby' | 'id'> & {
     ...
     * </p>
     * <p>
     * If the max property is set, it must either be set to null or set to an object with year and month defined, {year: number, month: IsoMonth},
     * where the IsoMonth type is a number 1-12, month: 1 for January, month: 2 for February, and so on.
     * Set null to clear the max. Do not set max to an empty object.
     * If the max is not set correctly, the component will throw an error and not render.
     * </p>
     * <p>
     * When set to null or not set at all, there is no maximum.
     * </p>
     *
     ...
     * </p>
     * <p>
     * If the min property is set, it must either be set to null or set to an object with year and month defined, {year: number, month: IsoMonth},
     * where the IsoMonth type is a number 1-12, month: 1 for January, month: 2 for February, and so on.
     * Set null to clear the min. Do not set min to an empty object.
     * If the min is not set correctly, the component will throw an error and not render.
     * </p>
     * <p>
     * When set to null or not set at all, there is no minimum.
     * </p>
     ...
     * </p>
     * <p>
     * If the value property is set, it must either be set to null or set to an object with year and month defined, {year: number, month: IsoMonth},
     * where the IsoMonth type is a number 1-12, month: 1 for January, month: 2 for February, and so on.
     * Set null to clear the value. Do not set value to an empty object.
     * If the value is not set correctly, the component will throw an error and not render.
     * </p>
     *
     * <p>
 ...
 * </p>
 *
 * @ojmetadata displayName "Input Month Mask"
...
export namespace CInputMonthMaskElement {
    ...
    type rawValueChanged = JetElementCustomEventStrict<Parameters<Required<Props>['onRawValueChanged']>[0]>;
    ...
    type validChanged = JetElementCustomEventStrict<Parameters<Required<Props>['onValidChanged']>[0]>;
...
export interface CInputMonthMaskElementEventMap extends HTMLElementEventMap {
    ...
    'rawValueChanged': JetElementCustomEventStrict<Parameters<Required<Props>['onRawValueChanged']>[0]>;
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<Props>['onValidChanged']>[0]>;
