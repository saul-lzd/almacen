define(["require", "exports", "preact/jsx-runtime", '@oracle/oraclejet-preact/translationBundle', "preact/hooks", "preact/compat", "@oracle/oraclejet-preact/hooks/UNSAFE_useBusyStateContext", "@oracle/oraclejet-preact/UNSAFE_VisProgressiveLoader", "@oracle/oraclejet-preact/UNSAFE_LineAreaChart", "@oracle/oraclejet-preact/UNSAFE_VisNoDataMessage", "@oracle/oraclejet-preact/hooks/UNSAFE_useLegendPreferredSize", "@oracle/oraclejet-preact/UNSAFE_TrackResizeContainer", "@oracle/oraclejet-preact/hooks/UNSAFE_useUser", "ojs/ojvcomponent", "../utils/PRIVATE_chartUtils/events", "../utils/PRIVATE_chartUtils/legendUtils", "../hooks/UNSAFE_useVizCategories/useVizCategories", "@oracle/oraclejet-preact/UNSAFE_Legend", "@oracle/oraclejet-preact/UNSAFE_ChartWithLegend", "../utils/PRIVATE_chartUtils/lineAreaUtils", "oj-c/utils/PRIVATE_chartUtils/plotAreaUtils", "../utils/PRIVATE_chartUtils/axisUtils", "../utils/PRIVATE_chartUtils/viewportUtils", "../utils/PRIVATE_chartUtils/preferredSizeUtils", "oj-c/hooks/PRIVATE_useVisContextMenu/useVisContextMenu", "oj-c/utils/PRIVATE_vizUtils/VisInvalidDataErrorBoundary", "oj-c/utils/PRIVATE_chartUtils/datatipUtil", "oj-c/hooks/UNSAFE_useChartData/useChartData", "css!oj-c/line-chart/line-chart-styles.css"], function (require, exports, jsx_runtime_1, translationBundle_1, hooks_1, compat_1, UNSAFE_useBusyStateContext_1, UNSAFE_VisProgressiveLoader_1, UNSAFE_LineAreaChart_1, UNSAFE_VisNoDataMessage_1, UNSAFE_useLegendPreferredSize_1, UNSAFE_TrackResizeContainer_1, UNSAFE_useUser_1, ojvcomponent_1, events_1, legendUtils_1, useVizCategories_1, UNSAFE_Legend_1, UNSAFE_ChartWithLegend_1, lineAreaUtils_1, plotAreaUtils_1, axisUtils_1, viewportUtils_1, preferredSizeUtils_1, useVisContextMenu_1, VisInvalidDataErrorBoundary_1, datatipUtil_1, useChartData_1) {
    "use strict";
     ...
     *
     */
    function LineChartImpl({ data, hideAndShowBehavior = 'none', orientation = 'vertical', xAxis, yAxis, y2Axis, hoverBehavior = 'none', valueFormats, plotArea, zoomAndScroll, itemTemplate, seriesTemplate, groupTemplate, datatipTemplate, datatipConfig, seriesComparator, groupComparator, drilling = 'off', hiddenCategories = HIDDEN_DEFAULT, timeAxisType, highlightedCategories = HIGHLIGHTED_DEFAULT, highlightMatch = 'any', selection = SELECTION_DEFAULT, selectionMode = 'none', stack = 'off', legend = LEGEND_DEFAULT, contextMenuConfig, onOjContextMenuAction, onOjContextMenuSelection, splitterPosition = 0.5, splitDualY = 'off', ...props }, ref) {
        ...
        const { series, groups, preactSeries, isLoading, idToDPItemMap, createGroupContext } = (0, useChartData_1.useChartData)(data, busyStateContext.addBusyState, itemTemplate, seriesTemplate, groupTemplate, 'oj-c-line-chart-item', 'oj-c-line-chart-series', 'oj-c-line-chart-group', seriesComparator, groupComparator, props.styleDefaults, 'line');
        const getDataItem = (0, hooks_1.useCallback)((seriesIndex, groupIndex) => {
            return preactSeries[seriesIndex].items[groupIndex];
        }, [preactSeries]);
        ...
        const legendData = (0, legendUtils_1.getLegendData)(preactSeries);
        ...
        const lineChartSizeRef = (0, hooks_1.useRef)(null);
        const [isGetPreferredSizeReady, setIsGetPreferredSizeReady] = (0, hooks_1.useState)(false);
        const prevPreferredSizeDepsRef = (0, hooks_1.useRef)({
            legend,
            series,
            groups
        });
        const preferredSizeDepsChanged = prevPreferredSizeDepsRef.current.legend !== legend ||
            prevPreferredSizeDepsRef.current.series !== series ||
            prevPreferredSizeDepsRef.current.groups !== groups;
        if (preferredSizeDepsChanged) {
            prevPreferredSizeDepsRef.current = { legend, series, groups };
            if (isGetPreferredSizeReady)
                setIsGetPreferredSizeReady(false);
        }
        const chartOffsetRef = (0, hooks_1.useRef)({ x: 0, y: 0 });
        (0, hooks_1.useImperativeHandle)(ref, () => ({
            _getYAxis: () => {
                const axis = lineChartSizeRef.current._getYaxis();
                if (!axis || !axis.bounds)
                    return axis;
                return { ...axis, bounds: (0, preferredSizeUtils_1.adjustForLegendOffset)(axis.bounds, chartOffsetRef.current) };
            },
            _getXAxis: () => {
                const axis = lineChartSizeRef.current._getXaxis();
                if (!axis || !axis.bounds)
                    return axis;
                return { ...axis, bounds: (0, preferredSizeUtils_1.adjustForLegendOffset)(axis.bounds, chartOffsetRef.current) };
            },
            _getY2Axis: () => {
                const axis = lineChartSizeRef.current._getY2axis();
                if (!axis || !axis.bounds)
                    return axis;
                return { ...axis, bounds: (0, preferredSizeUtils_1.adjustForLegendOffset)(axis.bounds, chartOffsetRef.current) };
            }
        }));
        const [viewport, onViewportChange] = (0, hooks_1.useState)({
            xMin: undefined,
            xMax: undefined,
            yMin: undefined,
            yMax: undefined,
        ...
        return ((0, jsx_runtime_1.jsx)(ojvcomponent_1.Root, { ref: rootRef, children: (0, jsx_runtime_1.jsx)(UNSAFE_TrackResizeContainer_1.TrackResizeContainer, { width: "100%", height: "100%", children: (_width, _height) => {
                    ...
                    // Compute and store chart offset based on legend using shared util
                    chartOffsetRef.current = (0, preferredSizeUtils_1.getChartLegendOffset)({
                        position: legendPosition,
                        isRtl,
                        renderLegend,
                        preferredSize: legendPreferredSize,
                        gap: legendGap
                    });
                    ...
                    const { startGroup: computedStartGroup, endGroup: computedEndGroup } = (0, viewportUtils_1.computeStartEndGroup)(viewport, groups, timeAxisType);
                    const chart = series.length > 0 && groups.length > 0 && isLegendDimsResolved ? ((0, jsx_runtime_1.jsx)(UNSAFE_LineAreaChart_1.LineAreaChart, { ref: lineChartSizeRef, type: "line", width: preactChartWidth, height: preactChartHeight, series: preactSeries, groups: groups, getDataItem: getDataItem, onItemHover: onItemInput, onItemFocus: onItemInput, drilling: drilling === 'seriesOnly' ? 'off' : drilling, dragMode: props.dragMode, onItemDrill: itemDrillHandler, onGroupDrill: groupDrillHandler, onSelectionChange: selectionChangeHandler, selectionMode: selectionMode, selectedIds: selectionMode === 'none' ? undefined : selection, orientation: orientation, xAxis: (0, axisUtils_1.getPreactAxisProps)({
                            ...xAxisRest,
                            timeAxisType,
                            viewportStartGroup: computedStartGroup,
                            viewportEndGroup: computedEndGroup
                        }, props.styleDefaults, viewport.xMin, viewport.xMax), yAxis: (0, axisUtils_1.getPreactAxisProps)(yAxisRest, undefined, viewport.yMin, viewport.yMax), y2Axis: {
                            ...(0, axisUtils_1.getPreactAxisProps)(y2AxisRest, undefined, viewport.y2Min, viewport.y2Max),
                            split: splitDualY === 'on' ? 1 - splitterPosition : 'off'
                        }, highlightedIds: highlightedIds.length === 0 ? undefined : highlightedIds, hiddenIds: hiddenIds, plotArea: (0, plotAreaUtils_1.getPlotArea)(plotArea, yMajorTick, yMinorTick, xMajorTick, y2MajorTick, y2MinorTick), hideAndShowBehavior: hideAndShowBehavior, hoverBehavior: hoverBehavior, isStacked: stack === 'on', valueFormats: (0, lineAreaUtils_1.transformValueFormats)(valueFormats), "aria-label": props['aria-label'], "aria-describedby": props['aria-describedby'], "aria-labelledby": props['aria-labelledby'], zoomAndScroll: zoomAndScroll, contextMenuConfig: contextMenuConfig ? preactContextMenuConfig : undefined, datatip: (detail) => (0, datatipUtil_1.getAreaChartDatatip)(detail, series, groups, idToDPItemMap, datatipTemplate, datatipConfig), onViewportChange: (vp) => {
                            const { xMin, xMax, yMin, yMax, y2Min, y2Max } = vp;
                            onViewportChange(vp);
                            const se = (0, viewportUtils_1.computeStartEndGroup)(vp, groups, timeAxisType);
                            props.onOjViewportChange?.({
                                startGroup: se.startGroup,
                                endGroup: se.endGroup,
                                xMin,
                                xMax,
                                yMin,
                                yMax,
                        ...
                        } })) : (!isLoading && ((0, jsx_runtime_1.jsx)(UNSAFE_VisNoDataMessage_1.VisNoDataMessage, { "aria-label": props['aria-label'], "aria-describedby": props['aria-describedby'], "aria-labelledby": props['aria-labelledby'] })));
                    ...
                    return ((0, jsx_runtime_1.jsx)(UNSAFE_VisProgressiveLoader_1.VisProgressiveLoader, { isLoading: isLoading, type: "line", "aria-label": props['aria-label'], "aria-describedBy": props['aria-describedby'], "aria-labelledBy": props['aria-labelledby'], children: (0, jsx_runtime_1.jsx)(VisInvalidDataErrorBoundary_1.VisInvalidDataErrorBoundary, { "aria-label": props['aria-label'], "aria-describedby": props['aria-describedby'], "aria-labelledby": props['aria-labelledby'], dependencies: [timeAxisType, series, groups, getDataItem], children: (0, jsx_runtime_1.jsx)(UNSAFE_ChartWithLegend_1.ChartWithLegend, { chart: chart, position: legendPosition, isRtl: false, legend: chartLegend }) }) }));
                } }) }));
    }
    ...
    const LineChartWithoutDefaultedGenerics = (0, ojvcomponent_1.registerCustomElement)('oj-c-line-chart', (0, compat_1.forwardRef)(LineChartImpl), "LineChart", { "properties": { "groupComparator": { "type": "function" }, "stack": { "type": "string", "enumValues": ["off", "on"] }, "drilling": { "type": "string", "enumValues": ["off", "on", "groupsOnly", "seriesOnly"] }, "orientation": { "type": "string", "enumValues": ["horizontal", "vertical"] }, "splitDualY": { "type": "string", "enumValues": ["off", "on"] }, "splitterPosition": { "type": "number" }, "timeAxisType": { "type": "string", "enumValues": ["enabled", "mixedFrequency", "skipGaps"] }, "yAxis": { "type": "object", "properties": { "dataMax": { "type": "number" }, "dataMin": { "type": "number" }, "max": { "type": "number" }, "min": { "type": "number" }, "majorTick": { "type": "object", "properties": { "lineColor": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] } } }, "minorTick": { "type": "object", "properties": { "lineColor": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] } } }, "tickLabel": { "type": "object", "properties": { "converter": { "type": "object" }, "rendered": { "type": "string", "enumValues": ["off", "on"] }, "style": { "type": "object" } } }, "viewportMin": { "type": "number" }, "viewportMax": { "type": "number" }, "step": { "type": "number" }, "size": { "type": "number" }, "maxSize": { "type": "number" }, "scale": { "type": "string", "enumValues": ["linear", "log"] }, "title": { "type": "string" }, "titleStyle": { "type": "object" } } }, "y2Axis": { "type": "object", "properties": { "dataMax": { "type": "number" }, "dataMin": { "type": "number" }, "max": { "type": "number" }, "min": { "type": "number" }, "majorTick": { "type": "object", "properties": { "lineColor": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] } } }, "minorTick": { "type": "object", "properties": { "lineColor": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] } } }, "tickLabel": { "type": "object", "properties": { "converter": { "type": "object" }, "rendered": { "type": "string", "enumValues": ["off", "on"] }, "style": { "type": "object" } } }, "viewportMin": { "type": "number" }, "viewportMax": { "type": "number" }, "step": { "type": "number" }, "size": { "type": "number" }, "maxSize": { "type": "number" }, "scale": { "type": "string", "enumValues": ["linear", "log"] }, "title": { "type": "string" }, "titleStyle": { "type": "object" } } }, "xAxis": { "type": "object", "properties": { "majorTick": { "type": "object", "properties": { "lineColor": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] } } }, "minorTick": { "type": "object", "properties": { "lineColor": { "type": "string" }, "lineStyle": { "type": "string", "enumValues": ["dashed", "solid", "dotted"] }, "lineWidth": { "type": "number" }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] } } }, "tickLabel": { "type": "object", "properties": { "converter": { "type": "object|Array<object>" }, "rendered": { "type": "string", "enumValues": ["off", "on"] }, "rotation": { "type": "string", "enumValues": ["auto", "none"] }, "style": { "type": "object" } } }, "viewportMin": { "type": "number" }, "viewportMax": { "type": "number" }, "step": { "type": "number" }, "size": { "type": "number" }, "maxSize": { "type": "number" }, "scale": { "type": "string", "enumValues": ["linear", "log"] }, "title": { "type": "string" }, "titleStyle": { "type": "object" } } }, "plotArea": { "type": "object", "properties": { "backgroundColor": { "type": "string" } } }, "zoomAndScroll": { "type": "string", "enumValues": ["off", "live"] }, "valueFormats": { "type": "object", "properties": { "group": { "type": "object", "properties": { "tooltipLabel": { "type": "string" }, "tooltipDisplay": { "type": "string", "enumValues": ["auto", "off"] } } }, "series": { "type": "object", "properties": { "tooltipLabel": { "type": "string" }, "tooltipDisplay": { "type": "string", "enumValues": ["auto", "off"] } } }, "value": { "type": "object", "properties": { "converter": { "type": "object" }, "tooltipLabel": { "type": "string" }, "tooltipDisplay": { "type": "string", "enumValues": ["auto", "off"] } } }, "y2": { "type": "object", "properties": { "converter": { "type": "object" }, "tooltipLabel": { "type": "string" }, "tooltipDisplay": { "type": "string", "enumValues": ["auto", "off"] } } }, "label": { "type": "object", "properties": { "tooltipLabel": { "type": "string" }, "tooltipDisplay": { "type": "string", "enumValues": ["auto", "off"] } } } } }, "styleDefaults": { "type": "object", "properties": { "groupSeparators": { "type": "object", "properties": { "rendered": { "type": "string", "enumValues": ["auto", "off"] }, "color": { "type": "string" } } }, "markerShape": { "type": "string", "enumValues": ["auto", "square", "circle", "diamond", "human", "plus", "star", "triangleDown", "triangleUp"] }, "markerColor": { "type": "string" }, "dataLabelPosition": { "type": "string", "enumValues": ["center", "belowMarker", "aboveMarker", "beforeMarker", "afterMarker"] } } }, "seriesComparator": { "type": "function" }, "data": { "type": "DataProvider|null" }, "selectionMode": { "type": "string", "enumValues": ["none", "multiple", "single"] }, "selection": { "type": "Array<string|number>", "writeback": true }, "dragMode": { "type": "string", "enumValues": ["off", "pan", "zoom", "select", "user"] }, "hiddenCategories": { "type": "Array<string>", "writeback": true }, "highlightedCategories": { "type": "Array<string>", "writeback": true }, "hideAndShowBehavior": { "type": "string", "enumValues": ["none", "withoutRescale", "withRescale"] }, "hoverBehavior": { "type": "string", "enumValues": ["none", "dim"] }, "highlightMatch": { "type": "string", "enumValues": ["all", "any"] }, "legend": { "type": "object", "properties": { "position": { "type": "string", "enumValues": ["auto", "end", "start", "top", "bottom"] }, "rendered": { "type": "string", "enumValues": ["auto", "off", "on"] }, "maxSize": { "type": "number|string" }, "size": { "type": "number|string" }, "symbolHeight": { "type": "number" }, "symbolWidth": { "type": "number" } } }, "contextMenuConfig": { "type": "object", "properties": { "accessibleLabel": { "type": "string" }, "items": { "type": "function" } } }, "datatipConfig": { "type": "function" } }, "slots": { "itemTemplate": { "data": {} }, "seriesTemplate": { "data": {} }, "groupTemplate": { "data": {} }, "datatipTemplate": { "data": {} } }, "events": { "ojItemDrill": {}, "ojSeriesDrill": {}, "ojGroupDrill": {}, "ojViewportChange": {}, "ojContextMenuAction": { "bubbles": true }, "ojContextMenuSelection": { "bubbles": true } }, "extension": { "_WRITEBACK_PROPS": ["selection", "hiddenCategories", "highlightedCategories"], "_READ_ONLY_PROPS": [], "_OBSERVED_GLOBAL_PROPS": ["aria-label", "aria-describedby", "aria-labelledby"] }, "methods": { "_getYAxis": {}, "_getXAxis": {}, "_getY2Axis": {} } }, { "hideAndShowBehavior": "none", "orientation": "vertical", "hoverBehavior": "none", "drilling": "off", "hiddenCategories": [], "highlightedCategories": [], "highlightMatch": "any", "selection": [], "selectionMode": "none", "stack": "off", "legend": { "rendered": "on", "position": "auto" }, "splitterPosition": 0.5, "splitDualY": "off" }, {
