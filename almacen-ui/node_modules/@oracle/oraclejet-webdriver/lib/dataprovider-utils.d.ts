 ...
 * ```
 */
export declare function fetchKeyByFilter<E, K, DataProviderProps = keyof SubType<E, DataProvider<K, any>>>(el: OjWebElement, dataProviderProp: DataProviderProps, filterDef: DataFilter.FilterDef<any>): Promise<K>;
export {};
