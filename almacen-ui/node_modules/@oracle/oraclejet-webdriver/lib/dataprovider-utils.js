...
async function fetchKeyByFilter(el, dataProviderProp, filterDef) {
    ...
    return (0, oj_module_proxy_1.executeWithModules)(el.getDriver(), ['CustomElementUtils'], [el, dataProviderProp, filterDef], ({ getElementProperty }, comp, dataProviderProp, filterDef) => {
