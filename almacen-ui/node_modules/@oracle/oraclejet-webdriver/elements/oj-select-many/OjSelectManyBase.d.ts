 ...
 */
export declare class OjSelectManyBase extends OjWebElement {
    /**
     ...
     *
     */
    getMaximumResultCount(): Promise<number>;
    /**
     ...
     *
     */
    getMinimumResultsForSearch(): Promise<number>;
    /**
     ...
     *
     */
    getOptionRenderer(): Promise<null | null>;
    /**
     ...
     *
     */
    getOptions(): Promise<Array<object> | object | null>;
    /**
     ...
     * @deprecated Since 8.0.0. Support for "native" mode rendering is deprecated because JET promotes a consistent Oracle UX based upon the Redwood design system. As a result, the theme variable "$selectRenderModeOptionDefault" is also deprecated.
     */
     ...
     *
     */
    changeValue(value: Array<any> | null): Promise<void>;
    /**
     ...
     *
     */
    getValue(): Promise<Array<any> | null>;
    /**
     ...
     *
     */
    changeValueOptions(valueOptions: null | Array<ValueOptions>): Promise<void>;
    /**
     ...
     *
     */
    getValueOptions(): Promise<null | Array<ValueOptions>>;
}
