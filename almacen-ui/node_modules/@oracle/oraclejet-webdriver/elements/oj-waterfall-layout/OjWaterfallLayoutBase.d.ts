...
export declare class OjWaterfallLayoutBase extends OjWebElement {
    ...
    /**
     * Gets the value of <code>tabManagement</code> property.
     * Specifies how oj-waterfall-layout manages the tabindex of tabbable items.
     * @return The value of <code>tabManagement</code> property.
     *
     */
    getTabManagement(): Promise<string>;
}
