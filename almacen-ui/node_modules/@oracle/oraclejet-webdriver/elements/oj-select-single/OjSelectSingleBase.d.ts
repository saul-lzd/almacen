 ...
 */
export declare class OjSelectSingleBase extends OjWebElement {
    /**
     ...
     *
     */
    getItemText(): Promise<string | null>;
    /**
     ...
     * The ordered list of text filter matching behaviors to use when filtering data.
     ...
     *
     */
    changeValue(value: null | any): Promise<void>;
    /**
     ...
     *
     */
    changeValueItem(valueItem: null | object): Promise<void>;
    /**
     ...
     *
     */
    getValueItem(): Promise<null | object>;
    /**
