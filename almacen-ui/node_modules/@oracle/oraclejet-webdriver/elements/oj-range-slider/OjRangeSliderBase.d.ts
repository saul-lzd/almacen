...
/**
 * This is the base class for oj-range-slider WebElement, and is generated from the
 * component's metadata. Do not modify these contents since they'll be replaced
 * during the next generation.
 * Put overrides into the WebElements's subclass, OjRangeSlider.ts.
 */
export declare class OjRangeSliderBase extends OjWebElement {
    /**
     ...
     * The maximum value of the range slider. See the Help documentation for more information.
     ...
     *
     */
    changeMessagesCustom(messagesCustom: Array<object>): Promise<void>;
    /**
     ...
     *
     */
    getMessagesCustom(): Promise<Array<object>>;
    /**
     * Gets the value of <code>min</code> property.
     * The minimum value of the range slider. See the Help documentation for more information.
     ...
     * Specifies the orientation of the range slider.
     ...
     *
     */
    getTransientValue(): Promise<TransientValue | null>;
    /**
     ...
     * The numerical value of the range-slider.
...
export interface TransientValue {
    /**
     * Specifies the end transientValue of the range selected.
     */
    end: number | null;
    /**
     * Specifies the start transientValue of the range selected.
     */
    start: number | null;
}
...
export interface Value {
    /**
     * Specifies the end value of the range selected.
     */
    end: number | null;
    /**
     * Specifies the start value of the range selected.
     */
    start: number | null;
}
