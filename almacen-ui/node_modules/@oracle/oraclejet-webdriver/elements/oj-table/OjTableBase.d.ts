 ...
 */
export declare class OjTableBase extends OjWebElement {
    /**
     ...
     *
     */
    getAccessibility(): Promise<Accessibility | null>;
    /**
     ...
     *
     */
    getAddRowDisplay(): Promise<string>;
    /**
     ...
     */
    getAs(): Promise<string>;
    /**
     * Gets the value of <code>columnResizeBehavior</code> property.
     * Specifies the column resize behavior for this Table. See the Help documentation for more information.
     ...
     *
     */
    changeColumns(columns: Array<Columns> | null): Promise<void>;
    /**
     ...
     *
     */
    getColumns(): Promise<Array<Columns> | null>;
    /**
     ...
     *
     */
    getColumnsDefault(): Promise<ColumnsDefault | null>;
    /**
     ...
     *
     */
    changeCurrentRow(currentRow: object): Promise<void>;
    /**
     ...
     *
     */
    changeEditRow(editRow: object): Promise<void>;
    /**
     ...
     *
     */
    getFirstSelectedRow(): Promise<FirstSelectedRow>;
    /**
    ...
    /**
     * Sets the value of <code>insertRowDisplay</code> property.
     * Specifies the visible location of the insert new row when addRowTemplate or addRowCellTemplate is present.
     * @param insertRowDisplay The value to set for <code>insertRowDisplay</code>
     *
     */
    changeInsertRowDisplay(insertRowDisplay: object): Promise<void>;
    /**
     * Gets the value of <code>insertRowDisplay</code> property.
     * Specifies the visible location of the insert new row when addRowTemplate or addRowCellTemplate is present.
     * @return The value of <code>insertRowDisplay</code> property.
     *
     */
    getInsertRowDisplay(): Promise<object>;
    /**
     ...
     *
     */
    getRowRenderer(): Promise<null | null>;
    /**
     ...
     *
     */
    getScrollPolicy(): Promise<string>;
    /**
     ...
     *
     */
    getScrollPolicyOptions(): Promise<ScrollPolicyOptions | null>;
    /**
     ...
     *
     */
    changeScrollPosition(scrollPosition: ScrollPosition): Promise<void>;
    /**
     ...
     *
     */
    getScrollToKey(): Promise<string | null>;
    /**
     ...
     */
    changeSelection(selection: Array<object>): Promise<void>;
    /**
     ...
     * @deprecated Since 7.0.0. Use selected attribute instead.
     */
    getSelection(): Promise<Array<object>>;
    /**
     ...
     *
     */
    getSelectionMode(): Promise<SelectionMode | null>;
    /**
     ...
     *
     */
    getSelectionRequired(): Promise<boolean>;
    /**
     ...
     *
     */
    getTranslations(): Promise<Translations | null>;
    /**
...
export interface SelectionMode {
    /**
     * Specifies the selection mode for columns. By default, column selection is disabled.
     */
    column: string;
    /**
     * Specifies the selection mode for rows. By default, row selection is disabled.
     */
    row: string;
}
