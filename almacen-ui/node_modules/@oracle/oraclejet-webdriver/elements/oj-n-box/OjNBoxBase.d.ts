 ...
 */
export declare class OjNBoxBase extends OjWebElement {
    /**
     ...
     *
     */
    getCellMaximize(): Promise<string>;
    /**
     ...
     *
     */
    getCells(): Promise<Array<Cells> | null | null>;
    /**
     ...
     *
     */
    getColumns(): Promise<Array<Columns> | null | null>;
    /**
     ...
     *
     */
    getColumnsTitle(): Promise<string>;
    /**
     ...
     *
     */
    getCountLabel(): Promise<null | null>;
    /**
     ...
     *
     */
    getDataTransferOptions(): Promise<DataTransferOptions>;
    /**
     ...
     *
     */
    getGroupAttributes(): Promise<Array<string>>;
    /**
     ...
     *
     */
    getGroupBehavior(): Promise<string>;
    /**
     ...
     *
     */
    getLabelTruncation(): Promise<string>;
    /**
     ...
     *
     */
    changeMaximizedColumn(maximizedColumn: string): Promise<void>;
    /**
     ...
     *
     */
    getMaximizedColumn(): Promise<string>;
    /**
     ...
     *
     */
    changeMaximizedRow(maximizedRow: string): Promise<void>;
    /**
     ...
     *
     */
    getMaximizedRow(): Promise<string>;
    /**
     ...
     *
     */
    getNodes(): Promise<Array<Nodes> | null | null>;
    /**
     ...
     *
     */
    getOtherThreshold(): Promise<number>;
    /**
     ...
     *
     */
    getRows(): Promise<Array<Rows> | null | null>;
    /**
...
export interface DataTransferOptions {
    /**
     * Allows copy on nbox node.
     */
    copy: string;
    /**
     * Allows cut on nbox node.
     */
    cut: string;
    /**
     * Allows paste on nbox cell.
     */
    paste: string;
}
