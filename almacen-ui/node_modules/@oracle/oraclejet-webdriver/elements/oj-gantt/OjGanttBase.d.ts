 ...
 */
export declare class OjGanttBase extends OjWebElement {
    /**
     ...
     *
     */
    getAnimationOnDataChange(): Promise<string>;
    /**
     ...
     *
     */
    getAnimationOnDisplay(): Promise<string>;
    /**
     ...
     *
     */
    getAxisPosition(): Promise<string>;
    /**
     ...
     *
     */
    getDependencies(): Promise<Array<Dependencies> | null>;
    /**
     ...
     *
     */
    getDependencyLineShape(): Promise<string>;
    /**
     ...
     *
     */
    getMajorAxis(): Promise<MajorAxis>;
    /**
     ...
     *
     */
    getMinorAxis(): Promise<MinorAxis>;
    /**
     * Gets the value of <code>parentRowPosition</code> property.
     * Specifies how parent rows behave when scrolling within the Gantt.
     * @return The value of <code>parentRowPosition</code> property.
     *
     */
    getParentRowPosition(): Promise<string>;
    /**
     ...
     *
     */
    getReferenceObjects(): Promise<Array<ReferenceObjects>>;
    /**
     ...
     *
     */
    getRowDefaults(): Promise<RowDefaults>;
    /**
     ...
     *
     */
    getRows(): Promise<Array<Rows> | null>;
    /**
     ...
     *
     */
    getTaskAggregation(): Promise<string>;
    /**
     ...
     *
     */
    getTaskDefaults(): Promise<TaskDefaults>;
    /**
     ...
     *
     */
    getViewportStart(): Promise<string>;
    /**
...
export interface MajorAxis {
    ...
    /**
     * Specifies whether major axis drilling is enabled.
     */
    drillable: string;
    /**
    ...
    scale: string;
    /**
     * An array of scales used for zooming from longest to shortest. See the Help documentation for more information.
     */
    zoomOrder: Array<string | unknown>;
}
...
export interface MinorAxis {
    ...
    /**
     * Specifies whether minor axis drilling is enabled.
     */
    drillable: string;
    /**
