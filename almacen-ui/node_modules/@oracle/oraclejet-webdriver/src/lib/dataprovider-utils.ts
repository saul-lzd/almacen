 ...
 * 
 * Note: This method is not intended for use with tree data providers.
 * 
 ...
 * ```
 */
export async function fetchKeyByFilter<
  E,
  K,
  DataProviderProps = keyof SubType<E, DataProvider<K, any>>
>(
  el: OjWebElement,
  ...
  return executeWithModules<Promise<K>>(
    el.getDriver(),
    ['CustomElementUtils'],
    [el, dataProviderProp, filterDef],
    ({ getElementProperty }, comp, dataProviderProp, filterDef): Promise<K> => {
