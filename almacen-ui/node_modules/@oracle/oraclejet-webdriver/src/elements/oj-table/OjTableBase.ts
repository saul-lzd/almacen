...
export class OjTableBase extends OjWebElement {
   ...
   *
   */
  public changeInsertRowDisplay(insertRowDisplay: object): Promise<void> {
    return this.setProperty<object>('insertRowDisplay', insertRowDisplay);
  }
   ...
   *
   */
  public getInsertRowDisplay(): Promise<object> {
    return this.getProperty<object>('insertRowDisplay');
  }
   ...
   *
   */
  public getSelectionMode(): Promise<SelectionMode | null> {
    return this.getProperty<SelectionMode | null>('selectionMode');
  }
