 ...
 */
export class OjRangeSliderBase extends OjWebElement {
  /**
   ...
   *
   */
  public getTransientValue(): Promise<TransientValue | null> {
    return this.getProperty<TransientValue | null>('transientValue');
  }
