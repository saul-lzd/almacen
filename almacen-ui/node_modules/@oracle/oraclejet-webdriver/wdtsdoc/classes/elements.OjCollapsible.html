<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>OjCollapsible | @oracle/oraclejet-webdriver</title><meta name="description" content="Documentation for @oracle/oraclejet-webdriver"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script><script async src="../assets/navigation.js" id="tsd-nav-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar"><div class="tsd-toolbar-contents container"><div class="table-cell" id="tsd-search" data-base=".."><div class="field"><label for="tsd-search-field" class="tsd-widget tsd-toolbar-icon search no-caption"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><use href="#icon-search"></use></svg></label><input type="text" id="tsd-search-field" aria-label="Search"/></div><div class="field"><div id="tsd-toolbar-links"></div></div><ul class="results"><li class="state loading">Preparing search index...</li><li class="state failure">The search index is not available</li></ul><a href="../index.html" class="title">@oracle/oraclejet-webdriver</a></div><div class="table-cell" id="tsd-widgets"><a href="#" class="tsd-widget tsd-toolbar-icon menu no-caption" data-toggle="menu" aria-label="Menu"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><use href="#icon-menu"></use></svg></a></div></div></header><div class="container container-main"><div class="col-content"><div class="tsd-page-title"><ul class="tsd-breadcrumb"><li><a href="../index.html">@oracle/oraclejet-webdriver</a></li><li><a href="../modules/elements.html">elements</a></li><li><a href="elements.OjCollapsible.html">OjCollapsible</a></li></ul><h1>Class OjCollapsible</h1></div><section class="tsd-panel tsd-comment"><div class="tsd-comment tsd-typography"><p>The component WebElement for <a href="../../jsdocs/oj.ojCollapsible.html">oj-collapsible</a>.
Do not instantiate this class directly, instead, use
<a href="../functions/elements.ojCollapsible-1.html">ojCollapsible</a>.
 <h4>Migration</h4>
 When you migrate a page from using <a href="../../jsdocs/oj.ojCollapsible.html">oj-collapsible</a> to <a href="../../jsdocs/oj-c.Collapsible.html">oj-c-collapsible</a> you will also need to migrate your WebDriver tests from OjCollapsible to CollapsibleWebElement. To do that you will need to revise type and locator instances as follows
 </br><b>Type:</b> from OjCollapsible to <a href="../../cpwdtsdoc/classes/CollapsibleWebElement.html">CollapsibleWebElement</a>
 </br><b>Locator:</b> from <a href="../functions/elements.ojCollapsible-1.html">ojCollapsible</a> to <a href="../../cpwdtsdoc/functions/findCollapsible.html">findCollapsible</a>
 </br>For more details on migrating from legacy to core pack please see component&#39;s <a href="../../jsdocs/oj.ojCollapsible.html#migration-section">migration section</a></p>
</div><div class="tsd-comment tsd-typography"></div></section><section class="tsd-panel tsd-hierarchy"><h4>Hierarchy</h4><ul class="tsd-hierarchy"><li><a href="elements._internal_.OjCollapsibleBase.html" class="tsd-signature-type tsd-kind-class">OjCollapsibleBase</a><ul class="tsd-hierarchy"><li><span class="target">OjCollapsible</span></li></ul></li></ul></section><section class="tsd-panel-group tsd-index-group"><section class="tsd-panel tsd-index-panel"><details class="tsd-index-content tsd-index-accordion" open><summary class="tsd-accordion-summary tsd-index-summary"><h5 class="tsd-index-heading uppercase" role="button" aria-expanded="false" tabIndex="0"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><use href="#icon-chevronSmall"></use></svg> Index</h5></summary><div class="tsd-accordion-details"><section class="tsd-index-section"><h3 class="tsd-index-heading">Constructors</h3><div class="tsd-index-list"><a href="elements.OjCollapsible.html#constructor" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-512"></use></svg><span>constructor</span></a>
</div></section><section class="tsd-index-section"><h3 class="tsd-index-heading">Methods</h3><div class="tsd-index-list"><a href="elements.OjCollapsible.html#changeExpanded" class="tsd-index-link deprecated"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>change<wbr/>Expanded</span></a>
<a href="elements.OjCollapsible.html#clear" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>clear</span></a>
<a href="elements.OjCollapsible.html#click" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>click</span></a>
<a href="elements.OjCollapsible.html#doCollapse" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>do<wbr/>Collapse</span></a>
<a href="elements.OjCollapsible.html#doExpand" class="tsd-index-link"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>do<wbr/>Expand</span></a>
<a href="elements.OjCollapsible.html#findElement" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>find<wbr/>Element</span></a>
<a href="elements.OjCollapsible.html#findElements" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>find<wbr/>Elements</span></a>
<a href="elements.OjCollapsible.html#getAttribute" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Attribute</span></a>
<a href="elements.OjCollapsible.html#getCssValue" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Css<wbr/>Value</span></a>
<a href="elements.OjCollapsible.html#getDisabled" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Disabled</span></a>
<a href="elements.OjCollapsible.html#getExpandArea" class="tsd-index-link deprecated tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Expand<wbr/>Area</span></a>
<a href="elements.OjCollapsible.html#getExpanded" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Expanded</span></a>
<a href="elements.OjCollapsible.html#getLocation" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Location</span></a>
<a href="elements.OjCollapsible.html#getProperty" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Property</span></a>
<a href="elements.OjCollapsible.html#getRect" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Rect</span></a>
<a href="elements.OjCollapsible.html#getSize" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Size</span></a>
<a href="elements.OjCollapsible.html#getText" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Text</span></a>
<a href="elements.OjCollapsible.html#getTranslations" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>get<wbr/>Translations</span></a>
<a href="elements.OjCollapsible.html#hasSize" class="tsd-index-link deprecated tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>has<wbr/>Size</span></a>
<a href="elements.OjCollapsible.html#hasVisibility" class="tsd-index-link deprecated tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>has<wbr/>Visibility</span></a>
<a href="elements.OjCollapsible.html#isDisplayed" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>is<wbr/>Displayed</span></a>
<a href="elements.OjCollapsible.html#isEnabled" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>is<wbr/>Enabled</span></a>
<a href="elements.OjCollapsible.html#isSelected" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>is<wbr/>Selected</span></a>
<a href="elements.OjCollapsible.html#sendKeys" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>send<wbr/>Keys</span></a>
<a href="elements.OjCollapsible.html#setProperty" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>set<wbr/>Property</span></a>
<a href="elements.OjCollapsible.html#submit" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>submit</span></a>
<a href="elements.OjCollapsible.html#takeScreenshot" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>take<wbr/>Screenshot</span></a>
<a href="elements.OjCollapsible.html#whenBusyContextReady" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>when<wbr/>Busy<wbr/>Context<wbr/>Ready</span></a>
<a href="elements.OjCollapsible.html#whenReady" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" viewBox="0 0 24 24"><use href="#icon-2048"></use></svg><span>when<wbr/>Ready</span></a>
</div></section></div></details></section></section><section class="tsd-panel-group tsd-member-group"><h2>Constructors</h2><section class="tsd-panel tsd-member tsd-is-inherited"><a id="constructor" class="tsd-anchor"></a><h3 class="tsd-anchor-link"><span>constructor</span><a href="#constructor" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></h3><ul class="tsd-signatures tsd-is-inherited"><li class="tsd-signature tsd-anchor-link" id="constructor.new_OjCollapsible"><span class="tsd-kind-constructor-signature">new <wbr/>Oj<wbr/>Collapsible</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">el</span>, <span class="tsd-kind-parameter">locators</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="elements.OjCollapsible.html" class="tsd-signature-type tsd-kind-class">OjCollapsible</a><a href="#constructor.new_OjCollapsible" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24"><use href="#icon-anchor"></use></svg></a></li><li class="tsd-description"><div class="tsd-comment tsd-typography"><p>Constructor.  Pass an instance of WebDriver&#39;s WebElement that
