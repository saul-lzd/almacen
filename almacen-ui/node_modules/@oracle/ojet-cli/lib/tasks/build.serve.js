  ...
  switch (scope) {
    ...
    case config.tasks.build.scopes.pack.name:
      if (utils.isWebpackApp()) {
        utils.log.error('Building components or packs is not supported in a Webpack-managed project. To build components and packs, please switch to a non-Webpack project');
        return Promise.reject();
      }
