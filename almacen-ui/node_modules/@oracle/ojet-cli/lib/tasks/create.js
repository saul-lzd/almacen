...
module.exports = function (scope, parameters, options) {
  ...
  switch (scope) {
    ...
    case scopes.component.name: {
      ...
      if (utils.isWebpackApp()) {
        utils.log.error('Creating components is not currently supported in projects using Webpack. Switch to a non-Webpack projects to create components.');
        return Promise.reject();
      }
    ...
    case scopes.pack.name: {
      ...
      if (utils.isWebpackApp()) {
        utils.log.error('Creating packs is not currently supported in projects using Webpack. Switch to a non-Webpack projects to create packs.');
        return Promise.reject();
      }
