    ...
    switch (this.scope) {
      ...
      case config.tasks[this.task].scopes.pack.name: {
        ...
        if (utils.isWebpackApp()) {
          utils.log.error('Packaging components or packs is not supported in a Webpack-based project. Switch to a non-Webpack projects to package components and packs.');
