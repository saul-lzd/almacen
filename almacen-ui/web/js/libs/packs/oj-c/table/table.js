define(["require", "exports", "preact/jsx-runtime", '@oracle/oraclejet-preact/translationBundle', "ojs/ojcustomelement-registry", "ojs/ojkeyset", "ojs/ojvcomponent", "preact/hooks", "./hooks/UNSAFE_useWhenReadyContext/useWhenReadyContext", "./hooks/UNSAFE_useCurrentCellOverride/useCurrentCellOverride", "../hooks/UNSAFE_useListData/useListData", "../utils/PRIVATE_keyUtils/keySetUtils", "@oracle/oraclejet-preact/hooks/UNSAFE_useBusyStateContext", "@oracle/oraclejet-preact/hooks/UNSAFE_useCollectionInteractionContext", "@oracle/oraclejet-preact/hooks/UNSAFE_useFormVariantContext", "@oracle/oraclejet-preact/hooks/UNSAFE_useTableViewColumnResizing", "../utils/PRIVATE_ItemsMenu/items-menu", "../list-view/useHandleRemoveCurrentKey", "@oracle/oraclejet-preact/UNSAFE_TableView", "./utils/TableRendererUtils", "css!oj-c/table/table-styles.css"], function (require, exports, jsx_runtime_1, translationBundle_1, ojcustomelement_registry_1, ojkeyset_1, ojvcomponent_1, hooks_1, useWhenReadyContext_1, useCurrentCellOverride_1, useListData_1, keySetUtils_1, UNSAFE_useBusyStateContext_1, UNSAFE_useCollectionInteractionContext_1, UNSAFE_useFormVariantContext_1, UNSAFE_useTableViewColumnResizing_1, items_menu_1, useHandleRemoveCurrentKey_1, UNSAFE_TableView_1, TableRendererUtils_1) {
    "use strict";
     ...
     */
    function TableImpl({ 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, 'aria-describedby': ariaDescribedBy, id, data, columns, row, horizontalGridVisible = 'enabled', verticalGridVisible = 'disabled', layout = 'contents', currentCellOverride, onCurrentCellChanged, selected = _selectedDefault, selectionMode = _selectionModeDefault, onSelectedChanged, selectAllControl = 'visible', columnOrder, cellTemplate, headerTemplate, footerTemplate, templates, onOjRowAction, noData, columnWidths, onColumnWidthsChanged, columnResizeBehavior = 'redistribute', scrollPolicyOptions = _scrollPolicyOptionsDefault, contextMenuConfig }) {
        ...
        const { preactCurrentCellOverride, onCurrentRowOverride, recordPersistedCell } = (0, useCurrentCellOverride_1.useCurrentCellOverride)(currentCellOverride);
        // Track when the current row key changes
        const { notifyCurrentKeyChanged } = (0, useHandleRemoveCurrentKey_1.useHandleRemoveCurrentKey)(listDataState.data, onCurrentRowOverride);
        ...
        // add a keyup handler to handle spacebar on select all column header
        const handleKeyUp = (0, hooks_1.useCallback)((event) => {
            if (event.key === ' ') {
        ...
        const selectAllHandlerProps = isMultipleRowSelection && selectAllControl !== 'hidden' ? { onKeyUp: handleKeyUp } : {};
        ...
        const preactData = listDataState.data?.data || [];
        ...
        const onPersistCurrentCell = (0, hooks_1.useCallback)((detail) => {
            ...
            if (value && value?.type === 'data') {
                ...
                notifyCurrentKeyChanged({ value: value.rowKey });
            }
        }, [onCurrentCellChanged, notifyCurrentKeyChanged, recordPersistedCell]);
        const itemsRenderer = (0, hooks_1.useCallback)((context) => {
            const hasDefault = context.defaultMenuItems != null;
            const corepackContext = context.type === 'data'
                ? {
                    type: 'data',
                    rowKey: context.rowKey,
                    columnKey: context.columnKey,
                    rowData: context.rowData.data,
                    hasDefaultMenuItems: hasDefault
                }
                : {
                    type: context.type,
                    columnKey: context.columnKey,
            ...
            const customItems = contextMenuConfig?.items(corepackContext);
            if (customItems != null && context != null) {
                const defaultItemsRenderer = {
                    defaultMenuItems: () => context.defaultMenuItems
                };
                return (0, jsx_runtime_1.jsx)(items_menu_1.ItemsMenu, { items: customItems, defaultItemsRenderer: defaultItemsRenderer });
            }
            return;
        }, [contextMenuConfig]);
        const preactContextMenuConfig = (0, hooks_1.useMemo)(() => {
            if (!contextMenuConfig) {
                return {
                    itemsRenderer: (context) => context.defaultMenuItems
                };
            }
            return {
                itemsRenderer,
        ...
        }, [contextMenuConfig, itemsRenderer]);
        ...
        return ((0, jsx_runtime_1.jsx)(ojvcomponent_1.Root, { id: id, ref: rootRef, children: (0, jsx_runtime_1.jsx)("div", { ref: tableViewRef, "data-oj-context": true, ...selectAllHandlerProps, ...(cellTemplate ? { 'data-oj-ct': true } : {}), ...(headerTemplate ? { 'data-oj-ht': true } : {}), ...(footerTemplate ? { 'data-oj-ft': true } : {}), ...(noData ? { 'data-oj-ndt': true } : {}), style: "display: contents;", children: (0, jsx_runtime_1.jsx)(UNSAFE_useFormVariantContext_1.FormVariantContext.Provider, { value: 'embedded', children: (0, jsx_runtime_1.jsx)(ojvcomponent_1.ReportBusyContext.Provider, { value: tableViewRef, children: (0, jsx_runtime_1.jsx)(UNSAFE_TableView_1.TableView, { "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, columns: preactColumns, contextMenuConfig: preactContextMenuConfig, data: preactData, getRowKey: TableRendererUtils_1.getPreactRowKey, getAccessibleRowHeaders: preactGetAccessibleRowHeaders, gridlines: gridlines, layout: isInitialLoading ? 'pending' : layout, selected: preactSelected, selectionMode: selectionMode, onSelectionChange: preactOnSelectionChange, columnOrder: preactColumnOrder, onRowAction: preactOnRowAction, noDataRenderer: noDataRenderer, onLoadMore: onLoadMore, hasMore: hasMore, currentCellOverride: preactCurrentCellOverride, onPersistCurrentCell: onPersistCurrentCell, width: '100%', ...columnResizingProps }) }) }) }) }));
    }
