...
export namespace CRichCheckboxsetElement {
    ...
    type validChanged<V extends string | number> = JetElementCustomEventStrict<Parameters<Required<RichCheckboxsetProps<V>>['onValidChanged']>[0]>;
...
export interface CRichCheckboxsetElementEventMap<V extends string | number> extends HTMLElementEventMap {
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<RichCheckboxsetProps<V>>['onValidChanged']>[0]>;
