...
export namespace CRatingGaugeElement {
    ...
    type transientValueChanged = JetElementCustomEventStrict<Parameters<Required<ComponentProps<typeof RatingGauge>>['onTransientValueChanged']>[0]>;
...
export interface CRatingGaugeElementEventMap extends HTMLElementEventMap {
    ...
    'transientValueChanged': JetElementCustomEventStrict<Parameters<Required<ComponentProps<typeof RatingGauge>>['onTransientValueChanged']>[0]>;
