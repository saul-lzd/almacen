...
/**
 * Payload for the ojAddToListAction event
 */
type AddToListActionPayload = Parameters<NonNullable<PreactSelectSingleProps['onAddToListAction']>>[0];
/**
...
type Props<V extends string | number, D extends Record<string, any>> = ObservedGlobalProps<'aria-describedby' | 'id'> & {
     ...
     * </p>
     *
     * @ojmetadata description "Specifies whether the add to list link is shown in the dropdown when the user filters."
     * @ojmetadata displayName "Add to List"
     * @ojmetadata help "#addToList"
     */
    addToList?: PreactSelectSingleProps['addToList'];
    /**
     * @description
     * <p>
    ...
    /**
     * @description
     * Event triggered when the user clicks or presses Enter on the add to list link in the
     * dropdown.
     * Set the <code class="prettyprint">addToList</code> property to
     * <code class="prettyprint">'on'</code> to enable this feature.
     *
     * @ojmetadata description Event triggered when the user clicks or presses Enter on the add
     * to list link in the dropdown.
     * @ojmetadata displayName "onOjAddToListAction"
     * @ojmetadata help "#event:addToListAction"
     */
    onOjAddToListAction?: Action<AddToListActionPayload>;
    /**
     * @description
...
type SelectSingleHandle<V> = {
    ...
    /**
     * @ojmetadata description "This method imitates triggering the add to list link in the dropdown.
...
export namespace CSelectSingleElement {
    interface ojAddToListAction extends CustomEvent<{
        searchText: string;
    }> {
    }
    ...
    type addToListChanged<V extends string | number, D extends Record<string, any>> = JetElementCustomEventStrict<CSelectSingleElement<V, D>['addToList']>;
    ...
    type validChanged<V extends string | number, D extends Record<string, any>> = JetElementCustomEventStrict<Parameters<Required<Props<V, D>>['onValidChanged']>[0]>;
...
export interface CSelectSingleElementEventMap<V extends string | number, D extends Record<string, any>> extends HTMLElementEventMap {
    'ojAddToListAction': CSelectSingleElement.ojAddToListAction;
    'ojAdvancedSearchAction': CSelectSingleElement.ojAdvancedSearchAction;
    'ojValueAction': CSelectSingleElement.ojValueAction<V, D>;
    'addToListChanged': JetElementCustomEventStrict<CSelectSingleElement<V, D>['addToList']>;
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<Props<V, D>>['onValidChanged']>[0]>;
...
export interface SelectSingleIntrinsicProps extends Partial<Readonly<CSelectSingleElementSettableProperties<any, any>>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
     ...
     * <code class="prettyprint">'on'</code> to enable this feature.
     */
    onojAddToListAction?: (value: CSelectSingleElementEventMap<any, any>['ojAddToListAction']) => void;
    /**
     * Event triggered when the user clicks or presses Enter on the advanced search link in the
     * dropdown.
     * Set the <code class="prettyprint">advancedSearch</code> property to
    ...
    onaddToListChanged?: (value: CSelectSingleElementEventMap<any, any>['addToListChanged']) => void;
