...
type Props = {
    /**
     * @ojmetadata description "Text to show in a non-icon-only button and as a tooltip when loading, or as tooltip for icon mode."
    ...
    label: string;
    /**
     * @ojmetadata description "Text to show in the tooltip. This overrides the default tooltip that renders the label when in icon mode, and can also be used to apply a tooltip for non-icon-only buttons."
