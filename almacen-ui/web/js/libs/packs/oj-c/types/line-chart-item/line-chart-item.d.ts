export type LineChartItemImplProps = {
     ...
     * @ojmetadata description "The description of this object."
     ...
     * @ojmetadata description "The label for the data item."
...
export namespace CLineChartItemElement {
    ...
    type labelChanged = JetElementCustomEventStrict<CLineChartItemElement['label']>;
...
export interface CLineChartItemElementEventMap extends HTMLElementEventMap {
    ...
    'labelChanged': JetElementCustomEventStrict<CLineChartItemElement['label']>;
...
export interface CLineChartItemElementSettableProperties extends JetSettableProperties {
     ...
     * The label for the data item.
     */
    label?: LineChartItemProps['label'];
    /**
     * Defines whether the data marker is displayed. If auto, the markers will be displayed whenever the data points are not connected by a line.
     */
...
export interface LineChartItemIntrinsicProps extends Partial<Readonly<CLineChartItemElementSettableProperties>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    onlabelChanged?: (value: CLineChartItemElementEventMap['labelChanged']) => void;
