 ...
 *
 * @ojmetadata displayName "Input Date Picker"
 ...
 */
declare function InputDatePickerImpl({ columnSpan, daysOutsideMonth, disabled, displayOptions, help, helpHints, max: propMax, min: propMin, messagesCustom, monthAndYearPicker, readonlyUserAssistanceShown, required, todayButton, validators, value, weekDisplay, ...otherProps }: Props, ref: Ref<InputDatePickerHandle>): import("preact").JSX.Element;
/**
