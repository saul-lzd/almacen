...
export namespace CRichRadiosetElement {
    ...
    type validChanged<V extends string | number> = JetElementCustomEventStrict<Parameters<Required<RichRadiosetProps<V>>['onValidChanged']>[0]>;
...
export interface CRichRadiosetElementEventMap<V extends string | number> extends HTMLElementEventMap {
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<RichRadiosetProps<V>>['onValidChanged']>[0]>;
