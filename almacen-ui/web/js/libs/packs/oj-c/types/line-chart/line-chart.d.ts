...
import { ReferenceObjectData } from '@oracle/oraclejet-preact/utils/UNSAFE_visTypes/chart';
import { ChartGroupTemplateContext, ChartItemTemplateContext, ChartSeriesTemplateContext } from 'oj-c/hooks/UNSAFE_useChartData/useChartData';
...
export type DatatipTemplateContext<K, D> = {
    ...
    /**
     * @description
     * The data object of the item. For nested items, it will be an array containing the parent item data and nested item data.
     */
    data?: LineAreaItem<K> | ReferenceObjectData;
    /**
     * @description
     * The ids or an array of ids of the group(s) the item belongs to. For hierarchical groups, it will be an array of outermost to innermost group ids.
     */
    group?: string | Array<string>;
    /**
     * @description
     * An array of data for the group the item belongs to. For hierarchical groups, it will be an array of outermost to innermost group data related to the item.
     */
    groupData?: Group[];
    /**
     * @description
    ...
    /**
     * @description
     * The data for the series the item belongs to.
     */
    seriesData?: LineChartSeries<K>;
    /**
     * @description
    ...
    /**
     * @description
     * The high value of the hovered item.
     */
    low?: number;
};
/**
...
export type DatatipConfig = {
    /**
     * @description
     * Defines if the datatip container is visually shown. For applications requiring full control over the datatip's appearance, the defaultContainer should be set to "disabled". In this mode, the content provided by the datatipTemplate slot takes up the whole datatip. This only applies if a datatipTemplate slot is used.
     */
...
type Props<K, D extends LineItem<K> | any> = ObservedGlobalProps<'aria-label' | 'aria-describedby' | 'aria-labelledby'> & {
    /**
     *
     * @description
    ...
    /**
     * @ojmetadata description "An object specifying value formatting and datatip behavior, whose keys generally correspond to the attribute names on the data items."
 ...
 */
export declare const LineChart: <K extends string | number = string | number, D extends LineItem<K> | any = LineItem<K> | any>(props: ExtendGlobalProps<Props<K, D>> & {
    ref?: AxisHandle;
}) => ComponentChildren;
export {};
...
declare namespace _CLineChartElementTypes {
    type _DatatipTemplateContext<K extends string | number, D extends LineItem<K> | any> = DatatipTemplateContext<K, D>;
}
export namespace CLineChartElement {
    ...
    type datatipConfigChanged<K extends string | number, D extends LineItem<K> | any> = JetElementCustomEventStrict<CLineChartElement<K, D>['datatipConfig']>;
    ...
    type DatatipTemplateContext<K extends string | number, D extends LineItem<K> | any> = _CLineChartElementTypes._DatatipTemplateContext<K, D>;
    type RenderDatatipTemplate<K extends string | number, D extends LineItem<K> | any> = import('ojs/ojvcomponent').TemplateSlot<DatatipTemplateContext<K, D>>;
}
export interface CLineChartElementEventMap<K extends string | number, D extends LineItem<K> | any> extends HTMLElementEventMap {
    ...
    'datatipConfigChanged': JetElementCustomEventStrict<CLineChartElement<K, D>['datatipConfig']>;
...
export interface LineChartIntrinsicProps extends Partial<Readonly<CLineChartElementSettableProperties<any, any>>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    ondatatipConfigChanged?: (value: CLineChartElementEventMap<any, any>['datatipConfigChanged']) => void;
