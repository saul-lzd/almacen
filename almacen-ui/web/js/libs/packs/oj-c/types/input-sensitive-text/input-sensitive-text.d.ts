...
export namespace CInputSensitiveTextElement {
    ...
    type rawValueChanged<V extends string = string> = JetElementCustomEventStrict<Parameters<Required<Props<V>>['onRawValueChanged']>[0]>;
    ...
    type validChanged<V extends string = string> = JetElementCustomEventStrict<Parameters<Required<Props<V>>['onValidChanged']>[0]>;
