...
export type LegendItemImplProps = {
    ...
    /**
     * @description
     * The description of this legend item. This is used for accessibility and for customizing the datatip text.
     * @ojmetadata description "The description of this legend item. This is used for accessibility and for customizing the datatip text."
