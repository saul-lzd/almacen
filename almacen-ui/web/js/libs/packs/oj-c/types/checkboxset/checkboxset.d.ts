...
export namespace CCheckboxsetElement {
    ...
    type validChanged<V extends string | number, D extends CheckboxsetDataItem> = JetElementCustomEventStrict<Parameters<Required<CheckboxsetProps<V, D>>['onValidChanged']>[0]>;
...
export interface CCheckboxsetElementEventMap<V extends string | number, D extends CheckboxsetDataItem> extends HTMLElementEventMap {
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<CheckboxsetProps<V, D>>['onValidChanged']>[0]>;
