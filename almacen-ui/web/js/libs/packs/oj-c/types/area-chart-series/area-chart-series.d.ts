...
export type AreaChartSeriesProps = {
     ...
     * @ojmetadata description "The area color of the series. Only applies if series type is area or lineWithArea."
     * @ojmetadata displayName "Area Color"
     * @ojmetadata help "#areaColor"
     */
    areaColor?: string;
    /**
     * @description
    ...
    /**
     * @description
     * The line type of the data of area chart.
     * @ojmetadata description "The line type of the data of area chart."
    ...
    /**
     * @description
     * Defines whether the data marker is displayed. If auto, the markers will be displayed whenever the data points are not connected by a line.
     * @ojmetadata description "Defines whether the data marker is displayed."
    ...
    /**
     * @description
     * The name of the series, displayed in the legend and datatips.
     * @ojmetadata description "The name of the series, displayed in the legend and datatips."
    ...
    /**
     * @description
     * The description of this series. This is used for accessibility and for customizing the datatip text on the corresponding legend item for the series.
     * @ojmetadata description "The description of this series. This is used for accessibility and for customizing the datatip text on the corresponding legend item for the series."
    ...
    /**
     * @description
     * The line style of the data line.
...
export namespace CAreaChartSeriesElement {
    type areaColorChanged = JetElementCustomEventStrict<CAreaChartSeriesElement['areaColor']>;
    ...
    type lineStyleChanged = JetElementCustomEventStrict<CAreaChartSeriesElement['lineStyle']>;
    type lineTypeChanged = JetElementCustomEventStrict<CAreaChartSeriesElement['lineType']>;
    type lineWidthChanged = JetElementCustomEventStrict<CAreaChartSeriesElement['lineWidth']>;
...
export interface CAreaChartSeriesElementEventMap extends HTMLElementEventMap {
    'areaColorChanged': JetElementCustomEventStrict<CAreaChartSeriesElement['areaColor']>;
    ...
    'lineStyleChanged': JetElementCustomEventStrict<CAreaChartSeriesElement['lineStyle']>;
    'lineTypeChanged': JetElementCustomEventStrict<CAreaChartSeriesElement['lineType']>;
    'lineWidthChanged': JetElementCustomEventStrict<CAreaChartSeriesElement['lineWidth']>;
...
export interface CAreaChartSeriesElementSettableProperties extends JetSettableProperties {
     ...
     * The area color of the series. Only applies if series type is area or lineWithArea.
     */
    areaColor?: AreaChartSeriesProps['areaColor'];
    /**
     * Defines whether the series is associated with the y2 axis.
     */
     ...
     * The line style of the data line.
     */
    lineStyle?: AreaChartSeriesProps['lineStyle'];
    /**
     * The line type of the data of area chart.
     */
     ...
     * The width of the data line.
     */
    lineWidth?: AreaChartSeriesProps['lineWidth'];
    /**
     * The color of the data markers, if different from the series color.
     */
...
export interface AreaChartSeriesIntrinsicProps extends Partial<Readonly<CAreaChartSeriesElementSettableProperties>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    onareaColorChanged?: (value: CAreaChartSeriesElementEventMap['areaColorChanged']) => void;
    ...
    onlineStyleChanged?: (value: CAreaChartSeriesElementEventMap['lineStyleChanged']) => void;
    onlineTypeChanged?: (value: CAreaChartSeriesElementEventMap['lineTypeChanged']) => void;
    onlineWidthChanged?: (value: CAreaChartSeriesElementEventMap['lineWidthChanged']) => void;
