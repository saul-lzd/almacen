...
import { Item, Section } from './legend';
/**
 * @description
 ...
 * @returns
 */
export declare function useSectionData<K, D, I extends Item<K>, S extends Section<K>>(dataProvider: ArrayTreeDataProvider<K, D>, addBusyState: (description: string) => () => void, sectionTemplate?: TemplateSlot<LegendSectionTemplateContext<K, D>>, itemTemplate?: TemplateSlot<LegendItemTemplateContext<K, D>>): {
    sections: S[];
