 ...
 * @ignore
 */
import { LegendItemData } from '@oracle/oraclejet-preact/utils/UNSAFE_visTypes/legend';
/**
 ...
 * @returns
 */
export declare function transformItem<D extends object>(dataItem: D, sectionIndex: number, itemIndex: number, ariaLabelSuffix: string, drilling?: 'on' | 'off', hideAndShowBehavior?: 'on' | 'off', isContextMenuEnabled?: boolean): LegendItemData<string>;
/**
