...
export namespace CMeterCircleElement {
    ...
    type transientValueChanged = JetElementCustomEventStrict<Parameters<Required<ComponentProps<typeof MeterCircle>>['onTransientValueChanged']>[0]>;
...
export interface CMeterCircleElementEventMap extends HTMLElementEventMap {
    ...
    'transientValueChanged': JetElementCustomEventStrict<Parameters<Required<ComponentProps<typeof MeterCircle>>['onTransientValueChanged']>[0]>;
