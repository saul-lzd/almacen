...
type ActionDetail = {
    /**
     * @ojmetadata description "trigger for the button action"
     */
...
type Props = ObservedGlobalProps<'aria-describedby' | 'aria-label'> & {
    ...
    /**
     * @ojmetadata description "Specifes the button type to be rendered. This can be used to prevent form submission from happening when the value is set to &quot;button&quot;."
     * @ojmetadata help "#buttonType"
     * @ojmetadata propertyEditorValues {
     *     "button": {
     ...
     *  }
     */
    buttonType?: PreactButtonProps['type'];
    /**
 ...
 * ]
 */
declare function ButtonImpl({ chroming, disabled, size, display, endIcon, startIcon, edge, tooltip, width, label, buttonType, onOjAction, 'aria-label': accessibleLabel, 'aria-describedby': ariaDescribedBy, ...otherProps }: Props, ref: Ref<ButtonHandle>): import("preact").JSX.Element;
/**
...
export namespace CButtonElement {
    ...
    type buttonTypeChanged = JetElementCustomEventStrict<CButtonElement['buttonType']>;
...
export interface CButtonElementEventMap extends HTMLElementEventMap {
    ...
    'buttonTypeChanged': JetElementCustomEventStrict<CButtonElement['buttonType']>;
...
export interface ButtonIntrinsicProps extends Partial<Readonly<CButtonElementSettableProperties>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    onbuttonTypeChanged?: (value: CButtonElementEventMap['buttonTypeChanged']) => void;
