...
export namespace CSelectMultipleElement {
    ...
    type validChanged<K extends string | number, D extends Record<string, any>> = JetElementCustomEventStrict<Parameters<Required<Props<K, D>>['onValidChanged']>[0]>;
...
export interface CSelectMultipleElementEventMap<K extends string | number, D extends Record<string, any>> extends HTMLElementEventMap {
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<Props<K, D>>['onValidChanged']>[0]>;
