 ...
 *       <td>Textarea</td>
 *       <td><kbd>Tap</kbd></td>
 *       <td>Sets focus to the textarea. Show user assistance text.</td>
 *     </tr>
 *   </tbody>
 * </table>
 *
 ...
 *       <td>Set focus to the textarea. Show user assistance text.</td>
 *     </tr>
 *     <tr>
 *       <td>Textarea</td>
 *       <td><kbd>Alt + Enter or Option + Enter<kbd></td>
 *       <td>Inserts a newline. Used as an alternative in collection use cases where enter/return means something different to the collection.</td>
 *     </tr>
 *   </tbody>
 * </table>
 *
...
export namespace CTextAreaElement {
    ...
    type rawValueChanged<V> = JetElementCustomEventStrict<Parameters<Required<Props<V>>['onRawValueChanged']>[0]>;
    ...
    type validChanged<V> = JetElementCustomEventStrict<Parameters<Required<Props<V>>['onValidChanged']>[0]>;
...
export interface CTextAreaElementEventMap<V> extends HTMLElementEventMap {
    ...
    'rawValueChanged': JetElementCustomEventStrict<Parameters<Required<Props<V>>['onRawValueChanged']>[0]>;
    ...
    'validChanged': JetElementCustomEventStrict<Parameters<Required<Props<V>>['onValidChanged']>[0]>;
