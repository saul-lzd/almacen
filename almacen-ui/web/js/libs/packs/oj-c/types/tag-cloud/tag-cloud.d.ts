...
export type DatatipTemplateContext<K> = {
    /**
     * @description
    ...
    /**
     * @description
     * The data label of the hovered item.
     */
    label?: string;
    /**
     * @description
     * The value of the hovered item.
     */
    value: number;
};
/**
...
export type TagCloudProps<K, D extends Item<K> | any> = ObservedGlobalProps<'aria-label' | 'aria-describedby' | 'aria-labelledby'> & {
     ...
     */
    datatipConfig?: (context: DatatipTemplateContext<K>) => DatatipConfig;
    /**
     * The datatipTemplate slot is used to specify custom datatip content.
     * @ojmetadata description "The datatipTemplate slot is used to specify custom datatip content."
     */
    datatipTemplate?: TemplateSlot<DatatipTemplateContext<K>>;
};
/**
 * @classdesc
...
declare namespace _CTagCloudElementTypes {
    type _DatatipTemplateContext<K extends string | number> = DatatipTemplateContext<K>;
}
export namespace CTagCloudElement {
    ...
    type datatipConfigChanged<K extends string | number, D extends Item<K> | any> = JetElementCustomEventStrict<CTagCloudElement<K, D>['datatipConfig']>;
    ...
    type DatatipTemplateContext<K extends string | number> = _CTagCloudElementTypes._DatatipTemplateContext<K>;
    type RenderDatatipTemplate<K extends string | number> = import('ojs/ojvcomponent').TemplateSlot<DatatipTemplateContext<K>>;
}
export interface CTagCloudElementEventMap<K extends string | number, D extends Item<K> | any> extends HTMLElementEventMap {
    ...
    'datatipConfigChanged': JetElementCustomEventStrict<CTagCloudElement<K, D>['datatipConfig']>;
...
export interface CTagCloudElementSettableProperties<K, D extends Item<K> | any> extends JetSettableProperties {
     ...
     * The DatatipConfig object is used to allow applications to control the appearance and behavior of the datatip.
     */
    datatipConfig?: TagCloudProps<K, D>['datatipConfig'];
    /**
     * An array of category strings used for highlighting. Data items matching categories in this array will be highlighted.
     */
...
export interface TagCloudIntrinsicProps extends Partial<Readonly<CTagCloudElementSettableProperties<any, any>>>, GlobalProps, Pick<preact.JSX.HTMLAttributes, 'ref' | 'key'> {
    ...
    ondatatipConfigChanged?: (value: CTagCloudElementEventMap<any, any>['datatipConfigChanged']) => void;
