...
export namespace CMeterBarElement {
    ...
    type transientValueChanged = JetElementCustomEventStrict<Parameters<Required<ComponentProps<typeof MeterBar>>['onTransientValueChanged']>[0]>;
...
export interface CMeterBarElementEventMap extends HTMLElementEventMap {
    ...
    'transientValueChanged': JetElementCustomEventStrict<Parameters<Required<ComponentProps<typeof MeterBar>>['onTransientValueChanged']>[0]>;
