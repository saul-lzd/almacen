...
//    public ProveedorEntity createProveedorFromContrato(ProveedorContratoDto proveedor) {
//        logger.info("Creating proveedor {}", proveedor.getRazonSocial());
//        return proveedorRepository.save(proveedorMapper.toEntity(proveedor));
//    }
//
